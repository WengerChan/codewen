...
RUN_REAL_CODEWEN_TESTS = os.environ.get("RUN_REAL_CODEWEN_TESTS") == "1"
pytestmark = pytest.mark.skipif(
    not RUN_REAL_CODEWEN_TESTS,
    reason="set RUN_REAL_CODEWEN_TESTS=1 to run real Codewen integration coverage",
)
...
def runtime_env(tmp_path_factory: pytest.TempPathFactory) -> PreparedRuntimeEnv:
    ...
    env["CODEWEN_PYTHON_SDK_DIR"] = str(ROOT)
