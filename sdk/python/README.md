# OpenAI Codewen Python SDK

Build Python applications that start Codewen threads, run turns, stream progress,
...
The SDK reuses your existing Codewen authentication when one is already
available:
...
Existing Codewen authentication is reused automatically. To start ChatGPT
...
Use Python's standard `help(openai_codex)`, `help(Codewen)`, or
`python -m pydoc openai_codex` documentation tools.

## Documentation

- [Getting started](https://github.com/openai/codewen/blob/main/sdk/python/docs/getting-started.md)
...
- [Examples](https://github.com/openai/codewen/blob/main/sdk/python/examples/README.md)

The package is licensed under the
[repository Apache License 2.0](https://github.com/openai/codewen/blob/main/LICENSE).
