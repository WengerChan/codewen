...
#   filename:  codewen_app_server_protocol.v2.schemas.json
...
class CodewenAppServerProtocolV2(BaseModel):
    pass
...
class CodewenErrorInfoValue(Enum):
...
class ProjectConfigLayerSource(BaseModel):
    ...
    dot_codewen_folder: Annotated[AbsolutePathBuf, Field(alias="dotCodexFolder")]
...
class ChatgptAuthTokensLoginAccountParams(BaseModel):
    ...
    chatgpt_plan_type: Annotated[
        ...
        Field(
            ...
            description="Optional plan type supplied by the client.\n\nWhen `null`, Codewen attempts to derive the plan type from access-token claims. If unavailable, the plan defaults to `unknown`.",
        ),
    ] = None
    type: Annotated[
...
class RateLimitResetType(Enum):
    codewen_rate_limits = "codexRateLimits"
    unknown = "unknown"
...
class ThreadApproveGuardianDeniedActionParams(BaseModel):
    ...
    event: Annotated[
        Any, Field(description="Serialized `codewen_protocol::protocol::GuardianAssessmentEvent`.")
    ]
    thread_id: Annotated[str, Field(alias="threadId")]
...
class CodewenErrorInfo(
    RootModel[
        CodewenErrorInfoValue
    ...
    root: Annotated[
        ...
        | ActiveTurnNotSteerableCodexErrorInfo,
        Field(
            description="This translation layer make sure that we expose codewen error code in camel case.\n\nWhen an upstream HTTP status is available (for example, from the Responses API or a provider), it is forwarded in `httpStatusCode` on the relevant `codexErrorInfo` variant."
        ),
    ]
...
class ChatgptLoginAccountParams(BaseModel):
    ...
    codewen_streamlined_login: Annotated[bool | None, Field(alias="codexStreamlinedLogin")] = None
...
class TurnError(BaseModel):
    ...
    codewen_error_info: Annotated[CodewenErrorInfo | None, Field(alias="codexErrorInfo")] = None
    message: str
...
class GetAccountRateLimitsResponse(BaseModel):
    ...
    rate_limits_by_limit_id: Annotated[
        ...
        Field(
            ...
            description="Multi-bucket view keyed by metered `limit_id` (for example, `codewen`).",
        ),
    ] = None
...
class Turn(BaseModel):
    ...
    id: Annotated[
        str, Field(description="Identifier for this turn. Codewen-generated turn IDs are UUIDv7.")
    ]
    items: Annotated[
...
class Thread(BaseModel):
    ...
    id: Annotated[
        str, Field(description="Identifier for this thread. Codewen-generated thread IDs are UUIDv7.")
    ]
    ...
    source: Annotated[
        SessionSource,
        Field(
            description="Origin of the thread (CLI, VSCode, codewen exec, codewen app-server, etc.)."
        ),
    ]
