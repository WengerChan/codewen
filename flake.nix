{
  description = "Development Nix flake for OpenAI Codewen CLI";
  ...
  outputs = { self, nixpkgs, rust-overlay, ... }:
    let
      ...
      cargoToml = builtins.fromTOML (builtins.readFile ./codewen-rs/Cargo.toml);
    ...
    in
    {
      packages = forAllSystems (system:
        let
          ...
          codewen-rs = pkgs.callPackage ./codewen-rs {
            inherit version;
