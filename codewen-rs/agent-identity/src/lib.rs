...
use codewen_http_client::HttpError;
use codewen_protocol::auth::PlanType as AuthPlanType;
...
const AGENT_IDENTITY_JWT_AUDIENCE: &str = "codewen-app-server";
const AGENT_IDENTITY_JWT_ISSUER: &str = "https://chatgpt.com/codewen-backend/agent-identity";
...
const AGENT_IDENTITY_KEY_DERIVATION_CONTEXT: &[u8] = b"codewen-agent-identity-ed25519-v1";
...
impl ChatGptEnvironment {
    pub fn from_chatgpt_base_url(chatgpt_base_url: &str) -> Result<Self> {
        match chatgpt_base_url.trim_end_matches('/') {
            ...
            | "https://chatgpt.com/codewen"
            | "https://chatgpt.com/backend-api/codewen"
            | "https://chat.openai.com"
            | "https://chat.openai.com/backend-api"
            | "https://chat.openai.com/codewen"
            | "https://chat.openai.com/backend-api/codewen" => Ok(Self::Production),
            "https://chatgpt-staging.com"
            | "https://chatgpt-staging.com/backend-api"
            | "https://chatgpt-staging.com/codewen"
            | "https://chatgpt-staging.com/backend-api/codewen" => Ok(Self::Staging),
            _ => anyhow::bail!(
...
pub fn build_abom(session_source: SessionSource) -> AgentBillOfMaterials {
    AgentBillOfMaterials {
        ...
        agent_harness_id: match &session_source {
            SessionSource::VSCode => "codewen-app".to_string(),
            SessionSource::Cli
            | SessionSource::Exec
            | SessionSource::Mcp
            ...
            | SessionSource::Unknown => "codewen-cli".to_string(),
        },
...
mod tests {
    ...
    use codewen_protocol::auth::KnownPlan;
...
-----END PRIVATE KEY-----"#,
    ...
    fn chatgpt_environment_maps_known_urls_to_authapi() -> anyhow::Result<()> {
        assert_eq!(
            ChatGptEnvironment::from_chatgpt_base_url("https://chatgpt.com/backend-api/codewen")?,
    ...
    fn agent_identity_jwks_url_uses_jwt_issuer_base_url() {
        assert_eq!(
            agent_identity_jwks_url("http://localhost:8080/api/codewen"),
            "http://localhost:8080/api/codewen/agent-identities/jwks"
        );
        assert_eq!(
            agent_identity_jwks_url("http://localhost:8080/api/codewen/"),
            "http://localhost:8080/api/codewen/agent-identities/jwks"
