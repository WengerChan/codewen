...
use codewen_execpolicy::rule::PatternToken;
use codewen_execpolicy::rule::PrefixPattern;
use codewen_execpolicy::rule::PrefixRule;
...
impl RequirementsExecPolicyToml {
    ...
    /// representation used by `codewen-execpolicy`.
