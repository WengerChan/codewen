...
/// Base config deserialized from ~/.codewen/config.toml.
...
pub struct ConfigToml {
    ...
    /// directories for `.codewen` folders. Defaults to [".git"] when unset.
    #[serde(default)]
...
pub struct DebugConfigLockToml {
    ...
    pub allow_codewen_version_mismatch: Option<bool>,
...
pub use codewen_protocol::protocol::RealtimeConversationVersion as RealtimeWsVersion;
pub use codewen_protocol::protocol::RealtimeVoice;
