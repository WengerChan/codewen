...
use codewen_app_server_protocol::Model;
use codewen_app_server_protocol::ModelListParams;
use codewen_app_server_protocol::ModelListResponse;
use codewen_app_server_protocol::ModelServiceTier;
use codewen_app_server_protocol::ModelUpgradeInfo;
use codewen_app_server_protocol::ReasoningEffortOption;
...
fn expected_visible_models() -> Vec<Model> {
    ...
    let mut presets = ModelPreset::filter_by_auth(
        codewen_core::test_support::all_model_presets().clone(),
        /*chatgpt_mode*/ false,
    );
