use codewen_app_server_protocol::AppBranding as ApiAppBranding;
use codewen_app_server_protocol::AppInfo as ApiAppInfo;
use codewen_app_server_protocol::AppMetadata as ApiAppMetadata;
use codewen_app_server_protocol::AppReview as ApiAppReview;
use codewen_app_server_protocol::AppScreenshot as ApiAppScreenshot;
use codewen_app_server_protocol::AppToolSummary as ApiAppToolSummary;
use codewen_app_server_protocol::ConnectorMetadata as ApiConnectorMetadata;
use codewen_connectors::AppBranding;
use codewen_connectors::AppInfo;
use codewen_connectors::AppMetadata;
use codewen_connectors::AppReview;
use codewen_connectors::AppScreenshot;
...
/// Converts connector-domain app metadata owned by `codewen-connectors` into the app-server wire
/// type owned by `codewen-app-server-protocol`.
///
