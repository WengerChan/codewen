...
use codewen_external_agent_migration::ExternalAgentConfigImportItemResult;
use codewen_external_agent_migration::record_import_error;
use codewen_external_agent_migration::sessions::CompletedExternalAgentSessionImport;
use codewen_external_agent_migration::sessions::ExternalAgentSessionMigration;
use codewen_external_agent_migration::sessions::ImportedExternalAgentSession;
use codewen_external_agent_migration::sessions::ImportedSessionConnectorAttribution;
use codewen_external_agent_migration::sessions::PendingSessionImport;
use codewen_external_agent_migration::sessions::SessionMetadataMode;
use codewen_external_agent_migration::sessions::detect_imported_cla_session_connectors;
use codewen_external_agent_migration::sessions::prepare_validated_session_import_with_metadata_mode;
use codewen_external_agent_migration::sessions::record_completed_session_imports;
...
impl ExternalAgentSessionImporter {
    ...
    pub(super) async fn import_sessions(
        ...
        let completed_imports = completed_imports
            ...
            .collect();
        if let Err(err) = record_completed_session_imports(&self.codewen_home, completed_imports) {
            record_import_error(
                &mut item_result,
    ...
    async fn persist_session(
        ...
        let create_params = CreateThreadParams {
            ...
            source: source.clone(),
            thread_source: None,
            originator: codewen_login::default_client::originator().value,
