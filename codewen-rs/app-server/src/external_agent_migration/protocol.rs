...
use codewen_app_server_protocol::CommandMigration;
...
use codewen_app_server_protocol::ExternalAgentConfigImportHistory;
use codewen_app_server_protocol::ExternalAgentConfigImportItemTypeFailure as ProtocolImportFailure;
use codewen_app_server_protocol::ExternalAgentConfigImportItemTypeSuccess as ProtocolImportSuccess;
use codewen_app_server_protocol::ExternalAgentConfigImportTypeResult as ProtocolImportTypeResult;
...
use codewen_app_server_protocol::HookMigration;
use codewen_app_server_protocol::JSONRPCErrorError;
use codewen_app_server_protocol::McpServerMigration;
use codewen_app_server_protocol::MigrationDetails;
use codewen_app_server_protocol::PluginsMigration;
use codewen_app_server_protocol::SkillMigration;
use codewen_app_server_protocol::SubagentMigration;
use codewen_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use codewen_external_agent_migration::ExternalAgentConfigImportRawError as CoreImportRawError;
use codewen_external_agent_migration::ExternalAgentConfigImportSuccess;
use codewen_external_agent_migration::ExternalAgentConfigMigrationItem as CoreMigrationItem;
use codewen_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use codewen_external_agent_migration::MigrationDetails as CoreMigrationDetails;
use codewen_external_agent_migration::NamedMigration;
use codewen_external_agent_migration::PluginsMigration as CorePluginsMigration;
use codewen_external_agent_migration::sessions::ExternalAgentSessionMigration;
...
fn protocol_migration_details(details: CoreMigrationDetails) -> MigrationDetails {
    MigrationDetails {
        ...
        sessions: details
            .sessions
            .into_iter()
            .map(|session| codewen_app_server_protocol::SessionMigration {
                path: session.path,
                cwd: session.cwd,
                title: session.title,
            })
...
pub(super) fn protocol_import_history(
    record: codewen_state::ExternalAgentConfigImportHistoryRecord,
