...
use codewen_analytics::ExternalAgentConfigImportCompletedInput;
use codewen_analytics::ExternalAgentConfigImportFailureInput;
...
use codewen_app_server_protocol::ExternalAgentConfigImportItemTypeFailure as ProtocolImportFailure;
...
use codewen_external_agent_migration::ExternalAgentConfigDetectOptions;
use codewen_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use codewen_external_agent_migration::ExternalAgentConfigImportOutcome as CoreImportOutcome;
use codewen_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use codewen_external_agent_migration::ExternalAgentConfigService;
use codewen_external_agent_migration::ExternalAgentSessionImportLimits;
use codewen_external_agent_migration::PluginImportOutcome;
use codewen_external_agent_migration::record_import_error;
use codewen_external_agent_migration::sessions::ExternalAgentSessionMigration as CoreSessionMigration;
use codewen_external_agent_migration::sessions::read_imported_connector_candidates;
use codewen_features::Feature;
use codewen_rollout::StateDbHandle;
use codewen_state::ExternalAgentConfigImportFailureRecord;
use codewen_state::ExternalAgentConfigImportSuccessRecord;
...
pub(crate) struct ExternalAgentConfigRequestProcessorArgs {
    ...
    pub(crate) codewen_home: PathBuf,
}
...
impl ExternalAgentConfigRequestProcessor {
    ...
    pub(crate) async fn read_import_histories(
        ...
        let connectors = read_imported_connector_candidates(self.migration_service.codewen_home())
            .map_err(|err| {
