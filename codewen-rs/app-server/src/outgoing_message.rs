...
use codewen_otel::span_w3c_trace_context;
...
pub(crate) use codewen_app_server_transport::ConnectionId;
pub(crate) use codewen_app_server_transport::OutgoingError;
pub(crate) use codewen_app_server_transport::OutgoingMessage;
pub(crate) use codewen_app_server_transport::OutgoingResponse;
pub(crate) use codewen_app_server_transport::QueuedOutgoingMessage;
...
mod tests {
    ...
    use codewen_app_server_protocol::ApplyPatchApprovalParams;
    ...
    fn verify_model_rerouted_notification_serialization() {
        let notification = ServerNotification::ModelRerouted(ModelReroutedNotification {
            ...
            from_model: "gpt-5.3-codewen".to_string(),
    ...
    async fn send_response_routes_to_target_connection() {
        ...
        let outgoing =
            OutgoingMessageSender::new(tx, codewen_analytics::AnalyticsEventsClient::disabled());
        ...
        outgoing
            .send_response(
                ...
                ClientResponsePayload::ThreadArchive(
                    codewen_app_server_protocol::ThreadArchiveResponse {},
                ),
            )
            .await;
