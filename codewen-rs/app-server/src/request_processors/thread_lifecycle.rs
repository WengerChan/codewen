...
pub(super) async fn wait_for_thread_shutdown(thread: &Arc<CodewenThread>) -> ThreadShutdownResult {
...
fn merge_active_turn_into_page(
    page: &mut codewen_app_server_protocol::TurnsPage,
    mut active_turn: Turn,
    params: &codewen_app_server_protocol::ThreadResumeInitialTurnsPageParams,
) {
