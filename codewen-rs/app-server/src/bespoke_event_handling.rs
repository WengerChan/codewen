...
use codewen_app_server_protocol::AccountRateLimitsUpdatedNotification;
use codewen_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use codewen_app_server_protocol::CodewenErrorInfo as V2CodexErrorInfo;
use codewen_app_server_protocol::CommandAction as V2ParsedCommand;
...
use codewen_app_server_protocol::DynamicToolCallParams;
use codewen_app_server_protocol::EnvironmentConnectionNotification;
use codewen_app_server_protocol::ErrorNotification;
use codewen_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use codewen_app_server_protocol::FileChangeApprovalDecision;
use codewen_app_server_protocol::FileChangeRequestApprovalParams;
use codewen_app_server_protocol::FileChangeRequestApprovalResponse;
use codewen_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use codewen_app_server_protocol::GuardianWarningNotification;
use codewen_app_server_protocol::HookCompletedNotification;
use codewen_app_server_protocol::HookStartedNotification;
use codewen_app_server_protocol::ItemCompletedNotification;
use codewen_app_server_protocol::ItemStartedNotification;
use codewen_app_server_protocol::McpServerElicitationAction;
use codewen_app_server_protocol::McpServerElicitationRequestParams;
use codewen_app_server_protocol::McpServerElicitationRequestResponse;
use codewen_app_server_protocol::McpServerStartupState;
use codewen_app_server_protocol::McpServerStatusUpdatedNotification;
use codewen_app_server_protocol::ModelReroutedNotification;
use codewen_app_server_protocol::ModelSafetyBufferingUpdatedNotification;
use codewen_app_server_protocol::ModelVerificationNotification;
use codewen_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use codewen_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use codewen_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use codewen_app_server_protocol::PermissionsRequestApprovalParams;
use codewen_app_server_protocol::PermissionsRequestApprovalResponse;
use codewen_app_server_protocol::RawResponseCompletedNotification;
use codewen_app_server_protocol::RawResponseItemCompletedNotification;
...
use codewen_app_server_protocol::ThreadRealtimeClosedNotification;
use codewen_app_server_protocol::ThreadRealtimeErrorNotification;
use codewen_app_server_protocol::ThreadRealtimeItemAddedNotification;
use codewen_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use codewen_app_server_protocol::ThreadRealtimeSdpNotification;
use codewen_app_server_protocol::ThreadRealtimeStartedNotification;
use codewen_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use codewen_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use codewen_app_server_protocol::ThreadRollbackResponse;
use codewen_app_server_protocol::ThreadSettingsUpdatedNotification;
use codewen_app_server_protocol::ThreadStatus;
use codewen_app_server_protocol::ThreadTokenUsage;
use codewen_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use codewen_app_server_protocol::ToolRequestUserInputOption;
use codewen_app_server_protocol::ToolRequestUserInputParams;
use codewen_app_server_protocol::ToolRequestUserInputQuestion;
use codewen_app_server_protocol::ToolRequestUserInputResponse;
...
use codewen_app_server_protocol::TurnModerationMetadataNotification;
use codewen_app_server_protocol::TurnPlanStep;
use codewen_app_server_protocol::TurnPlanUpdatedNotification;
use codewen_app_server_protocol::TurnStartedNotification;
use codewen_app_server_protocol::TurnStatus;
use codewen_app_server_protocol::WarningNotification;
use codewen_app_server_protocol::build_item_from_guardian_event;
use codewen_app_server_protocol::guardian_auto_approval_review_notification;
use codewen_app_server_protocol::item_event_to_server_notification;
use codewen_core::CodewenThread;
use codewen_core::ThreadManager;
use codewen_protocol::ThreadId;
use codewen_protocol::items::CollabAgentTool as CoreCollabAgentTool;
use codewen_protocol::items::TurnItem as CoreTurnItem;
use codewen_protocol::models::AdditionalPermissionProfile as CoreAdditionalPermissionProfile;
use codewen_protocol::plan_tool::UpdatePlanArgs;
use codewen_protocol::protocol::CodewenErrorInfo as CoreCodexErrorInfo;
use codewen_protocol::protocol::Event;
use codewen_protocol::protocol::EventMsg;
use codewen_protocol::protocol::ExecApprovalRequestEvent;
use codewen_protocol::protocol::Op;
use codewen_protocol::protocol::RealtimeEvent;
use codewen_protocol::protocol::ReviewDecision;
use codewen_protocol::protocol::SubAgentActivityKind;
...
use codewen_protocol::protocol::TurnDiffEvent;
...
use codewen_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use codewen_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use codewen_sandboxing::policy_transforms::intersect_permission_profiles;
use codewen_shell_command::parse_command::shlex_join;
use codewen_utils_absolute_path::AbsolutePathBuf;
use codewen_utils_path_uri::LegacyAppPathString;
...
pub(crate) async fn apply_bespoke_event_handling(
    ...
    conversation: Arc<CodewenThread>,
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            let (status, error, failure_reason) = match update.status {
                codewen_protocol::protocol::McpStartupStatus::Starting => {
                    (McpServerStartupState::Starting, None, None)
                }
                codewen_protocol::protocol::McpStartupStatus::Ready => {
                    (McpServerStartupState::Ready, None, None)
                }
                codewen_protocol::protocol::McpStartupStatus::Failed { error, reason } => (
                    McpServerStartupState::Failed,
                    Some(error),
                    reason.map(Into::into),
                ),
                codewen_protocol::protocol::McpStartupStatus::Cancelled => {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            ...
            if assessment.status == codewen_protocol::protocol::GuardianAssessmentStatus::InProgress
            ...
            let completion_status = match assessment.status {
                codewen_protocol::protocol::GuardianAssessmentStatus::Denied
                | codewen_protocol::protocol::GuardianAssessmentStatus::Aborted => {
                    Some(CommandExecutionStatus::Declined)
                }
                codewen_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                    Some(CommandExecutionStatus::Failed)
                }
                codewen_protocol::protocol::GuardianAssessmentStatus::InProgress
                | codewen_protocol::protocol::GuardianAssessmentStatus::Approved => None,
            };
                ...
                Err(err) => {
                    ...
                    if let Err(err) = conversation
                        .submit(Op::ResolveElicitation {
                            ...
                            request_id: request.id,
                            decision: codewen_protocol::approvals::ElicitationAction::Cancel,
                            content: None,
                            meta: None,
                        })
                        .await
        ...
        EventMsg::Error(ev) => {
            ...
            let codewen_error_info = ev.codewen_error_info.clone();
            ...
            let turn_error = TurnError {
                message: ev.message,
                codewen_error_info: ev.codewen_error_info.map(V2CodexErrorInfo::from),
...
async fn maybe_emit_raw_response_item_completed(
    conversation_id: ThreadId,
    turn_id: &str,
    item: codewen_protocol::models::ResponseItem,
    outgoing: &ThreadScopedOutgoingMessageSender,
) {
...
fn thread_rollback_response_from_stored_thread(
    stored_thread: codewen_thread_store::StoredThread,
    session_id: String,
...
async fn on_mcp_server_elicitation_response(
    server_name: String,
    request_id: codewen_protocol::mcp::RequestId,
    pending_request_id: RequestId,
    receiver: oneshot::Receiver<ClientRequestResult>,
    conversation: Arc<CodewenThread>,
    thread_state: Arc<Mutex<ThreadState>>,
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: codewen_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            codewen_app_server_protocol::PermissionGrantScope::Session
        )
    {
...
mod tests {
    ...
    use anyhow::bail;
    use chrono::Utc;
    use codewen_app_server_protocol::AutoReviewDecisionSource;
    ...
    use codewen_app_server_protocol::TurnPlanStepStatus;
    use codewen_login::CodewenAuth;
    use codewen_protocol::AgentPath;
    use codewen_protocol::items::DynamicToolCallItem;
    use codewen_protocol::items::DynamicToolCallStatus as CoreDynamicToolCallStatus;
    use codewen_protocol::items::SubAgentActivityItem;
    use codewen_protocol::items::TurnItem as CoreTurnItem;
    use codewen_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
    ...
    use codewen_protocol::plan_tool::PlanItemArg;
    use codewen_protocol::plan_tool::StepStatus;
    use codewen_protocol::protocol::AgentMessageEvent;
    use codewen_protocol::protocol::AskForApproval;
    use codewen_protocol::protocol::CreditsSnapshot;
    use codewen_protocol::protocol::EventMsg;
    use codewen_protocol::protocol::GuardianAssessmentEvent;
    use codewen_protocol::protocol::GuardianAssessmentStatus;
    use codewen_protocol::protocol::ItemCompletedEvent;
    use codewen_protocol::protocol::ItemStartedEvent;
    ...
    use codewen_thread_store::StoredThreadHistory;
    use codewen_utils_absolute_path::AbsolutePathBuf;
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            started_at: None,
            reason: codewen_protocol::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(codewen_protocol::protocol::GuardianRiskLevel::Low),
                Some(codewen_protocol::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(codewen_protocol::protocol::GuardianRiskLevel::High),
                Some(codewen_protocol::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(codewen_protocol::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = codewen_protocol::protocol::GuardianAssessmentAction::Command {
            source: codewen_protocol::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: codewen_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(codewen_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(codewen_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        let conversation_id = ThreadId::new();
        let action = codewen_protocol::protocol::GuardianAssessmentAction::NetworkAccess {
            target: "api.openai.com:443".to_string(),
            host: "api.openai.com".to_string(),
            protocol: codewen_protocol::protocol::NetworkApprovalProtocol::Https,
            port: 443,
        };
        let notification = guardian_auto_approval_review_notification(
            &conversation_id,
            ...
            &GuardianAssessmentEvent {
                ...
                started_at_ms: 1_000,
                completed_at_ms: Some(1_042),
                status: codewen_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    async fn command_execution_started_helper_emits_once() -> Result<()> {
        ...
        let outgoing = Arc::new(OutgoingMessageSender::new(
            tx,
            codewen_analytics::AnalyticsEventsClient::disabled(),
        ));
    ...
    async fn guardian_command_execution_notifications_wrap_review_lifecycle() -> Result<()> {
        ...
        let config = load_default_config_for_test(&codewen_home).await;
        let thread_manager = Arc::new(
            codewen_core::test_support::thread_manager_with_models_provider_and_home(
                CodewenAuth::create_dummy_chatgpt_auth_for_testing(),
                config.model_provider.clone(),
                config.codewen_home.to_path_buf(),
                Arc::new(codewen_exec_server::EnvironmentManager::default_for_tests()),
            ),
        );
        let codewen_core::NewThread {
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                codewen_error_info: Some(V2CodexErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn turn_started_omits_active_snapshot_items() -> Result<()> {
        ...
        let thread_state = new_thread_state();
        {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::TurnStarted(codewen_protocol::protocol::TurnStartedEvent {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::UserMessage(codewen_protocol::protocol::UserMessageEvent {
                    client_id: None,
        ...
        apply_bespoke_event_handling(
            Event {
                id: "turn-1".to_string(),
                msg: EventMsg::TurnStarted(codewen_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
                    trace_id: None,
                    started_at: Some(42),
                    model_context_window: None,
        ...
        assert_eq!(
            ...
            ItemCompletedNotification {
                item: ThreadItem::SubAgentActivity {
                    id: "activity-1".to_string(),
                    kind: codewen_app_server_protocol::SubAgentActivityKind::Interrupted,
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                codewen_error_info: Some(V2CodexErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_token_count_event_emits_usage_and_rate_limits() -> Result<()> {
        ...
        match second {
            ServerNotification::AccountRateLimitsUpdated(payload) => {
                assert_eq!(payload.rate_limits.limit_id.as_deref(), Some("codewen"));
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                codewen_error_info: Some(V2CodexErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
