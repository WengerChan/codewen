//! Helpers for truncating tool and exec output using [`TruncationPolicy`](codewen_protocol::protocol::TruncationPolicy).

use codewen_protocol::models::FunctionCallOutputContentItem;
pub use codewen_utils_string::approx_bytes_for_tokens;
pub use codewen_utils_string::approx_token_count;
pub use codewen_utils_string::approx_tokens_from_byte_count;
use codewen_utils_string::truncate_middle_chars;
use codewen_utils_string::truncate_middle_with_token_budget;

pub use codewen_protocol::protocol::TruncationPolicy;
