# codewen-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and Codewen did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust Codewen on it. Feel free to update the documentation as you
modify the code
...
```rust
use codewen_utils_stream_parser::CitationStreamParser;
use codewen_utils_stream_parser::StreamTextParser;
...
```rust
use codewen_utils_stream_parser::CitationStreamParser;
use codewen_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), codewen_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use codewen_utils_stream_parser::InlineHiddenTagParser;
use codewen_utils_stream_parser::InlineTagSpec;
use codewen_utils_stream_parser::StreamTextParser;
