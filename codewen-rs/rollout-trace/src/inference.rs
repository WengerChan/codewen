...
const INFERENCE_CALL_ID_HEADER: &str = "x-codewen-inference-call-id";
...
impl InferenceTraceAttempt {
    ...
    pub fn record_started(&self, request: &impl Serialize) {
        ...
        append_with_context_best_effort(
            ...
            RawTraceEventPayload::InferenceStarted {
                ...
                codewen_turn_id: attempt.context.codewen_turn_id.clone(),
    ...
    /// trace-specific serialization rules. That keeps codewen-core focused on
...
fn append_with_context_best_effort(
    ...
    let event_context = RawTraceEventContext {
        ...
        codewen_turn_id: Some(context.codewen_turn_id.clone()),
    };
...
mod tests {
    ...
    fn enabled_context_records_replayable_inference_attempt() -> anyhow::Result<()> {
        ...
        assert_eq!(inference.codewen_turn_id, "turn-1");
