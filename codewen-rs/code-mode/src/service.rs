...
use codewen_code_mode_protocol::CodeModeSession;
use codewen_code_mode_protocol::CodeModeSessionDelegate;
use codewen_code_mode_protocol::CodeModeSessionProvider;
use codewen_code_mode_protocol::CodeModeSessionProviderFuture;
use codewen_code_mode_protocol::CodeModeSessionResultFuture;
use codewen_code_mode_protocol::CodeModeToolKind;
use codewen_code_mode_protocol::DEFAULT_EXEC_YIELD_TIME_MS;
use codewen_code_mode_protocol::ExecuteRequest;
use codewen_code_mode_protocol::ExecuteToPendingOutcome;
use codewen_code_mode_protocol::FunctionCallOutputContentItem;
use codewen_code_mode_protocol::ImageDetail;
use codewen_code_mode_protocol::NotificationFuture;
use codewen_code_mode_protocol::RuntimeResponse;
use codewen_code_mode_protocol::StartedCell;
use codewen_code_mode_protocol::ToolInvocationFuture;
use codewen_code_mode_protocol::WaitOutcome;
use codewen_code_mode_protocol::WaitRequest;
use codewen_code_mode_protocol::WaitToPendingOutcome;
use codewen_code_mode_protocol::WaitToPendingRequest;
        ...
        self.delegate
            .invoke_tool(
                CodeModeNestedToolCall {
                    ...
                    tool_name: codewen_protocol::ToolName {
