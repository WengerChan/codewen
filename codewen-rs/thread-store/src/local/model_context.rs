...
use codewen_rollout::ModelContextScan;
use codewen_rollout::ModelContextScanProgress;
use codewen_rollout::ReverseJsonlScanner;
use codewen_rollout::ScanOutcome;
...
pub(super) async fn load_latest_model_context(
    ...
    let session_meta = codewen_rollout::read_session_meta_line(path.as_path())
        .await
