...
use codewen_rollout::first_rollout_content_match_snippet;
use codewen_rollout::parse_cursor;
use codewen_rollout::search_rollout_matches;
...
struct ThreadSearchItem {
    item: codewen_rollout::ThreadItem,
    snippet: String,
}
...
pub(super) async fn search_threads(
    ...
    loop {
        ...
        for item in page.items {
            let logical_path = codewen_rollout::plain_rollout_path(item.path.as_path());
