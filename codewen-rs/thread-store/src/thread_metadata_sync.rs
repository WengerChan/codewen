...
use codewen_protocol::protocol::user_message_preview;
...
impl ThreadMetadataSync {
    ...
    pub(crate) fn observe_appended_items(
        ...
        let affects_metadata = items
            .iter()
            .any(codewen_state::rollout_item_affects_thread_metadata);
...
mod tests {
    ...
    fn thread_settings_applied_updates_live_metadata() {
        ...
        assert_eq!(update.patch.model.as_deref(), Some("gpt-5.2-codewen"));
        assert_eq!(
