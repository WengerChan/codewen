...
use codewen_rollout::persisted_rollout_items;
...
fn git_info_from_patch(patch: &ThreadMetadataPatch) -> Option<codewen_protocol::protocol::GitInfo> {
    ...
    Some(codewen_protocol::protocol::GitInfo {
