...
use codewen_http_client::cache_system_proxy_route_for_test;
...
use codewen_login::token_data::IdTokenInfo;
...
const SYSTEM_PROXY_TEST_SUBPROCESS_ENV_VAR: &str = "CODEWEN_AUTH_SYSTEM_PROXY_TEST_SUBPROCESS";
const SYSTEM_PROXY_TEST_PROXY_URL_ENV_VAR: &str = "CODEWEN_AUTH_SYSTEM_PROXY_TEST_PROXY_URL";
...
async fn refresh_token_honors_respect_system_proxy() -> Result<()> {
    ...
    let auth_manager = AuthManager::shared(
        ...
        /*auth_route_config*/
        codewen_login::AuthRouteConfig::from_http_client_factory(HttpClientFactory::new(
