...
impl AuthEnvTelemetry {
    pub fn to_otel_metadata(&self) -> AuthEnvTelemetryMetadata {
        AuthEnvTelemetryMetadata {
            ...
            codewen_api_key_env_present: self.codewen_api_key_env_present,
            codewen_api_key_env_enabled: self.codewen_api_key_env_enabled,
...
pub fn collect_auth_env_telemetry(
    ...
    codewen_api_key_env_enabled: bool,
) -> AuthEnvTelemetry {
    AuthEnvTelemetry {
        openai_api_key_env_present: env_var_present(OPENAI_API_KEY_ENV_VAR),
        codewen_api_key_env_present: env_var_present(CODEX_API_KEY_ENV_VAR),
        codewen_api_key_env_enabled,
...
mod tests {
    ...
    fn collect_auth_env_telemetry_buckets_provider_env_key_name() {
        ...
        let telemetry =
            collect_auth_env_telemetry(&provider, /*codewen_api_key_env_enabled*/ false);
