...
//!
//! Use [`crate::default_client`] or [`codewen_login::default_client`] from other crates in this
//! workspace.

use codewen_http_client::BuildRouteAwareHttpClientError;
...
pub use codewen_http_client::RequestBuilder as CodewenRequestBuilder;
...
/// See https://github.com/yourname/codewen/pull/3388/files for an example of what that would look like.
...
pub const DEFAULT_ORIGINATOR: &str = "codewen_cli_rs";
pub const CODEX_INTERNAL_ORIGINATOR_OVERRIDE_ENV_VAR: &str = "CODEWEN_INTERNAL_ORIGINATOR_OVERRIDE";
pub const RESIDENCY_HEADER_NAME: &str = "x-openai-internal-codewen-residency";

pub use codewen_config::ResidencyRequirement;
...
pub fn is_first_party_originator(originator_value: &str) -> bool {
    originator_value == DEFAULT_ORIGINATOR
        || originator_value == "codewen-tui"
        || originator_value == "codewen_vscode"
        || originator_value.starts_with("Codex ")
}

pub fn is_first_party_chat_originator(originator_value: &str) -> bool {
    originator_value == "codewen_atlas" || originator_value == "codewen_chatgpt_desktop"
}

pub fn get_codewen_user_agent() -> String {
...
pub fn default_headers() -> HeaderMap {
    ...
    if let Ok(user_agent) = HeaderValue::from_str(&get_codewen_user_agent()) {
...
fn is_sandboxed() -> bool {
    std::env::var("CODEWEN_SANDBOX").as_deref() == Ok("seatbelt")
}
