...
impl TurnCodexErrorFact {
    pub fn from_codewen_err(thread_id: String, turn_id: String, error: &CodewenErr) -> Self {
        Self {
            turn_id,
            thread_id,
            error: TurnCodexError::from_codewen_err(error),
        }
    }
}
...
pub(crate) struct TurnCodexError {
    pub(crate) kind: CodewenErrKind,
    pub(crate) http_status_code: Option<u16>,
}

impl TurnCodexError {
    fn from_codewen_err(error: &CodewenErr) -> Self {
        Self {
            kind: error.into(),
...
impl From<&CodewenErr> for CodewenErrKind {
    fn from(error: &CodewenErr) -> Self {
        match error {
            CodewenErr::TurnAborted => CodewenErrKind::TurnAborted,
            CodewenErr::SessionBudgetExceeded => CodewenErrKind::SessionBudgetExceeded,
            CodewenErr::Stream(..) => CodewenErrKind::Stream,
            CodewenErr::ContextWindowExceeded => CodewenErrKind::ContextWindowExceeded,
            CodewenErr::ThreadNotFound(_) => CodewenErrKind::ThreadNotFound,
            CodewenErr::AgentLimitReached { .. } => CodewenErrKind::AgentLimitReached,
            CodewenErr::SessionConfiguredNotFirstEvent => {
                CodewenErrKind::SessionConfiguredNotFirstEvent
            }
            CodewenErr::Timeout => CodewenErrKind::Timeout,
            CodewenErr::RequestTimeout => CodewenErrKind::RequestTimeout,
            CodewenErr::Spawn => CodewenErrKind::Spawn,
            CodewenErr::Interrupted => CodewenErrKind::Interrupted,
            CodewenErr::UnexpectedStatus(_) => CodewenErrKind::UnexpectedStatus,
            CodewenErr::InvalidRequest(_) => CodewenErrKind::InvalidRequest,
            CodewenErr::InvalidImageRequest() => CodewenErrKind::InvalidImageRequest,
            CodewenErr::UsageLimitReached(_) => CodewenErrKind::UsageLimitReached,
            CodewenErr::ServerOverloaded => CodewenErrKind::ServerOverloaded,
            CodewenErr::CyberPolicy { .. } => CodewenErrKind::CyberPolicy,
            CodewenErr::ResponseStreamFailed(_) => CodewenErrKind::ResponseStreamFailed,
            CodewenErr::ConnectionFailed(_) => CodewenErrKind::ConnectionFailed,
            CodewenErr::QuotaExceeded => CodewenErrKind::QuotaExceeded,
            CodewenErr::UsageNotIncluded => CodewenErrKind::UsageNotIncluded,
            CodewenErr::InternalServerError => CodewenErrKind::InternalServerError,
            CodewenErr::RetryLimit(_) => CodewenErrKind::RetryLimit,
            CodewenErr::InternalAgentDied => CodewenErrKind::InternalAgentDied,
            CodewenErr::Sandbox(_) => CodewenErrKind::Sandbox,
            CodewenErr::LandlockSandboxExecutableNotProvided => {
                CodewenErrKind::LandlockSandboxExecutableNotProvided
            }
            CodewenErr::UnsupportedOperation(_) => CodewenErrKind::UnsupportedOperation,
            CodewenErr::RefreshTokenFailed(_) => CodewenErrKind::RefreshTokenFailed,
            CodewenErr::Fatal(_) => CodewenErrKind::Fatal,
            CodewenErr::Io(_) => CodewenErrKind::Io,
            CodewenErr::Json(_) => CodewenErrKind::Json,
            #[cfg(target_os = "linux")]
            CodewenErr::LandlockRuleset(_) => CodewenErrKind::LandlockRuleset,
            #[cfg(target_os = "linux")]
            CodewenErr::LandlockPathFd(_) => CodewenErrKind::LandlockPathFd,
            CodewenErr::TokioJoin(_) => CodewenErrKind::TokioJoin,
            CodewenErr::EnvVar(_) => CodewenErrKind::EnvVar,
        }
    }
}
...
#[derive(Clone)]
pub struct CodewenTurnSteerEvent {
...
#[derive(Clone)]
pub struct CodewenCompactionEvent {
    pub thread_id: String,
    pub turn_id: String,
    ...
    pub codewen_error_kind: Option<CodewenErrKind>,
    pub codewen_error_http_status_code: Option<u16>,
...
#[derive(Clone)]
pub struct CodewenGoalEvent {
    pub thread_id: String,
    pub turn_id: Option<String>,
    pub goal_id: String,
    pub event_kind: GoalEventKind,
    pub goal_status: codewen_state::ThreadGoalStatus,
...
pub(crate) enum CustomAnalyticsFact {
    ...
    Compaction(Box<CodewenCompactionEvent>),
    Goal(Box<CodewenGoalEvent>),
