...
use codewen_protocol::models::SandboxPermissions;
use codewen_protocol::protocol::GuardianAssessmentOutcome;
use codewen_protocol::protocol::GuardianCommandSource;
use codewen_protocol::protocol::GuardianRiskLevel;
use codewen_protocol::protocol::GuardianUserAuthorization;
...
pub(crate) enum TrackEventRequest {
    ...
    AppMentioned(CodewenAppMentionedEventRequest),
    AppUsed(CodewenAppUsedEventRequest),
    HookRun(CodewenHookRunEventRequest),
    Compaction(Box<CodewenCompactionEventRequest>),
    Goal(Box<CodewenGoalEventRequest>),
    TurnEvent(Box<CodewenTurnEventRequest>),
    TurnSteer(CodewenTurnSteerEventRequest),
    CommandExecution(CodewenCommandExecutionEventRequest),
    FileChange(CodewenFileChangeEventRequest),
    McpToolCall(CodewenMcpToolCallEventRequest),
    DynamicToolCall(CodewenDynamicToolCallEventRequest),
    CollabAgentToolCall(CodewenCollabAgentToolCallEventRequest),
    WebSearch(CodewenWebSearchEventRequest),
    ImageGeneration(CodewenImageGenerationEventRequest),
    AcceptedLineFingerprints(Box<CodewenAcceptedLineFingerprintsEventRequest>),
    #[allow(dead_code)]
    ReviewEvent(CodewenReviewEventRequest),
    PluginUsed(CodewenPluginUsedEventRequest),
    PluginInstallRequested(CodewenPluginInstallRequestedEventRequest),
    PluginInstalled(CodewenPluginEventRequest),
    PluginUninstalled(CodewenPluginEventRequest),
    PluginEnabled(CodewenPluginEventRequest),
    PluginDisabled(CodewenPluginEventRequest),
    PluginInstallFailed(CodewenPluginInstallFailedEventRequest),
    ExternalAgentConfigImportCompleted(CodewenOnboardingExternalAgentImportCompleteEventRequest),
    ExternalAgentConfigImportFailure(CodewenOnboardingExternalAgentImportFailureEventRequest),
}
...
#[derive(Serialize)]
pub(crate) struct CodewenAcceptedLineFingerprintsEventParams {
...
#[derive(Serialize)]
pub(crate) struct CodewenAcceptedLineFingerprintsEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenAcceptedLineFingerprintsEventParams,
}
...
pub(crate) struct CodewenAppServerClientMetadata {
...
#[derive(Clone, Serialize)]
pub(crate) struct CodewenRuntimeMetadata {
    pub(crate) codewen_rs_version: String,
...
pub(crate) struct ThreadInitializedEventParams {
    ...
    pub(crate) app_server_client: CodewenAppServerClientMetadata,
    pub(crate) runtime: CodewenRuntimeMetadata,
...
#[derive(Serialize)]
pub(crate) struct CodewenToolItemEventBase {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct CodewenReviewEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct CodewenReviewEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenReviewEventParams,
}
#[allow(dead_code)]
#[derive(Clone, Copy, Debug, Serialize)]
#[serde(rename_all = "snake_case")]
...
#[derive(Serialize)]
pub(crate) struct CodewenCommandExecutionEventParams {
    #[serde(flatten)]
    pub(crate) base: CodewenToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct CodewenCommandExecutionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenCommandExecutionEventParams,
}

#[derive(Serialize)]
pub(crate) struct CodewenFileChangeEventParams {
    #[serde(flatten)]
    pub(crate) base: CodewenToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct CodewenFileChangeEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenFileChangeEventParams,
}

#[derive(Serialize)]
pub(crate) struct CodewenMcpToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: CodewenToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct CodewenMcpToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenMcpToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct CodewenDynamicToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: CodewenToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct CodewenDynamicToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenDynamicToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct CodewenCollabAgentToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: CodewenToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct CodewenCollabAgentToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenCollabAgentToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct CodewenWebSearchEventParams {
    #[serde(flatten)]
    pub(crate) base: CodewenToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct CodewenWebSearchEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenWebSearchEventParams,
}

#[derive(Serialize)]
pub(crate) struct CodewenImageGenerationEventParams {
    #[serde(flatten)]
    pub(crate) base: CodewenToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct CodewenImageGenerationEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenImageGenerationEventParams,
}

#[derive(Serialize)]
pub(crate) struct CodewenAppMetadata {
    pub(crate) connector_id: Option<String>,
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct CodewenAppMentionedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct CodewenAppUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct CodewenHookRunMetadata {
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
    pub(crate) product_client_id: Option<String>,
    pub(crate) model_slug: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct CodewenHookRunEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenHookRunMetadata,
}

#[derive(Serialize)]
pub(crate) struct CodewenCompactionEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
    pub(crate) app_server_client: CodewenAppServerClientMetadata,
    ...
    pub(crate) codewen_error_kind: Option<CodewenErrKind>,
    pub(crate) codewen_error_http_status_code: Option<u16>,
...
#[derive(Serialize)]
pub(crate) struct CodewenCompactionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenCompactionEventParams,
}

#[derive(Serialize)]
pub(crate) struct CodewenGoalEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: Option<String>,
    pub(crate) app_server_client: CodewenAppServerClientMetadata,
    ...
    pub(crate) goal_status: codewen_state::ThreadGoalStatus,
...
#[derive(Serialize)]
pub(crate) struct CodewenGoalEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenGoalEventParams,
}

#[derive(Serialize)]
pub(crate) struct CodewenTurnEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
    ...
    pub(crate) turn_error: Option<CodewenErrorInfo>,
    pub(crate) codewen_error_kind: Option<CodewenErrKind>,
    pub(crate) codewen_error_http_status_code: Option<u16>,
...
#[derive(Serialize)]
pub(crate) struct CodewenTurnEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenTurnEventParams,
}

#[derive(Serialize)]
pub(crate) struct CodewenTurnSteerEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
...
#[derive(Serialize)]
pub(crate) struct CodewenTurnSteerEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenTurnSteerEventParams,
}

#[derive(Serialize)]
pub(crate) struct CodewenPluginMetadata {
    pub(crate) plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct CodewenPluginUsedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: CodewenPluginMetadata,
...
#[derive(Serialize)]
pub(crate) struct CodewenPluginInstallRequestedPluginMetadata {
...
#[derive(Serialize)]
pub(crate) struct CodewenPluginInstallRequestedMetadata {
    pub(crate) suggestion_id: String,
    pub(crate) plugins: Vec<CodewenPluginInstallRequestedPluginMetadata>,
...
#[derive(Serialize)]
pub(crate) struct CodewenPluginInstallRequestedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenPluginInstallRequestedMetadata,
}

#[derive(Serialize)]
pub(crate) struct CodewenPluginEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenPluginMetadata,
}

#[derive(Serialize)]
pub(crate) struct CodewenPluginInstallFailedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: CodewenPluginMetadata,
...
#[derive(Serialize)]
pub(crate) struct CodewenPluginInstallFailedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenPluginInstallFailedMetadata,
}

#[derive(Serialize)]
pub(crate) struct CodewenOnboardingExternalAgentImportCompleteMetadata {
...
#[derive(Serialize)]
pub(crate) struct CodewenOnboardingExternalAgentImportCompleteEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenOnboardingExternalAgentImportCompleteMetadata,
}

#[derive(Serialize)]
pub(crate) struct CodewenOnboardingExternalAgentImportFailureMetadata {
    pub(crate) import_id: String,
    pub(crate) source: String,
    pub(crate) provider_id: String,
    #[serde(rename = "type")]
...
#[derive(Serialize)]
pub(crate) struct CodewenOnboardingExternalAgentImportFailureEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenOnboardingExternalAgentImportFailureMetadata,
}

#[derive(Serialize)]
pub(crate) struct CodewenPluginUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: CodewenPluginUsedMetadata,
}

pub(crate) fn plugin_state_event_type(state: PluginState) -> &'static str {
    match state {
        PluginState::Installed => "codewen_plugin_installed",
        PluginState::Uninstalled => "codewen_plugin_uninstalled",
        PluginState::Enabled => "codewen_plugin_enabled",
        PluginState::Disabled => "codewen_plugin_disabled",
    }
}

pub(crate) fn codewen_app_metadata(
...
pub(crate) fn codewen_plugin_metadata(plugin: PluginTelemetryMetadata) -> CodewenPluginMetadata {
    codewen_plugin_metadata_with_product_client_id(plugin, originator().value)
}

fn codewen_plugin_metadata_with_product_client_id(
    plugin: PluginTelemetryMetadata,
    product_client_id: String,
) -> CodewenPluginMetadata {
...
pub(crate) fn codewen_plugin_install_requested_metadata(
    tracking: &TrackEventsContext,
    request: PluginInstallRequested,
) -> CodewenPluginInstallRequestedMetadata {
    CodewenPluginInstallRequestedMetadata {
        suggestion_id: request.suggestion_id,
        plugins: request
            .plugins
            .into_iter()
            .map(|plugin| CodewenPluginInstallRequestedPluginMetadata {
...
pub(crate) fn codewen_compaction_event_params(
    ...
    CodewenCompactionEventParams {
        ...
        status: input.status,
        codewen_error_kind: input.codewen_error_kind,
        codewen_error_http_status_code: input.codewen_error_http_status_code,
...
pub(crate) fn codewen_goal_event_params(
    input: CodewenGoalEvent,
    session_id: String,
    app_server_client: CodewenAppServerClientMetadata,
    runtime: CodewenRuntimeMetadata,
    thread_source: Option<ThreadSource>,
...
pub(crate) fn codewen_plugin_used_metadata(
    tracking: &TrackEventsContext,
    plugin: PluginTelemetryMetadata,
) -> CodewenPluginUsedMetadata {
    let mcp_server_names = plugin
        .capability_summary
        .as_ref()
        .map(|summary| summary.mcp_server_names.clone());
    CodewenPluginUsedMetadata {
        plugin: codewen_plugin_metadata_with_product_client_id(
            plugin,
...
pub(crate) fn codewen_hook_run_metadata(
    tracking: &TrackEventsContext,
    hook: HookRunFact,
) -> CodewenHookRunMetadata {
    CodewenHookRunMetadata {
        thread_id: Some(tracking.thread_id.clone()),
        turn_id: Some(tracking.turn_id.clone()),
        product_client_id: Some(tracking.product_client_id.clone()),
...
pub(crate) fn current_runtime_metadata() -> CodewenRuntimeMetadata {
    let os_info = os_info::get();
    CodewenRuntimeMetadata {
        codewen_rs_version: env!("CARGO_PKG_VERSION").to_string(),
