...
mod codewen_tool_config;
mod codewen_tool_runner;
mod exec_approval;
...
pub use crate::codewen_tool_config::CodewenToolCallParam;
pub use crate::codewen_tool_config::CodewenToolCallReplyParam;
...
const OTEL_SERVICE_NAME: &str = "codewen_mcp_server";
...
mod tests {
    ...
    async fn mcp_server_builds_otel_provider_with_logs_traces_and_metrics() -> anyhow::Result<()> {
        ...
        let provider = codewen_core::otel_init::build_provider(
            &config,
            "0.0.0-test",
            Some(OTEL_SERVICE_NAME),
            DEFAULT_ANALYTICS_ENABLED,
