use codewen_collaboration_mode_templates::DEFAULT as COLLABORATION_MODE_DEFAULT;
use codewen_collaboration_mode_templates::PLAN as COLLABORATION_MODE_PLAN;
use codewen_protocol::config_types::CollaborationModeMask;
use codewen_protocol::config_types::ModeKind;
use codewen_protocol::config_types::TUI_VISIBLE_COLLABORATION_MODES;
