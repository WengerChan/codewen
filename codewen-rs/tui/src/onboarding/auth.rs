...
use codewen_app_server_protocol::AuthMode as ApiAuthMode;
...
fn onboarding_request_id() -> codewen_app_server_protocol::RequestId {
    codewen_app_server_protocol::RequestId::String(Uuid::new_v4().to_string())
}
...
pub(super) async fn cancel_login_attempt(
    ...
    let _ = request_handle
        .request_typed::<codewen_app_server_protocol::CancelLoginAccountResponse>(
        ...
        let lines = vec![
            ...
            Line::from(vec![
                ...
                crate::terminal_hyperlinks::osc8_hyperlink(
                    "https://developers.openai.com/codewen/security",
                    "Codex docs",
                )
                .underlined(),
            ])
...
mod tests {
    ...
    async fn widget_forced_chatgpt() -> (AuthModeWidget, TempDir) {
        ...
        let config = ConfigBuilder::default()
            .codewen_home(codewen_home_path.clone())
            .build()
            .await
            .unwrap();
        ...
        let client = InProcessAppServerClient::start(InProcessClientStartArgs {
            ...
            environment_manager: Arc::new(
                codewen_app_server_client::EnvironmentManager::default_for_tests(),
            ),
