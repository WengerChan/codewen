...
use codewen_app_server_protocol::HookOutputEntry;
use codewen_app_server_protocol::HookOutputEntryKind;
use codewen_app_server_protocol::HookRunStatus;
use codewen_app_server_protocol::HookRunSummary;
use ratatui::prelude::*;
