...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) approvals_reviewer: codewen_protocol::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<codewen_protocol::openai_models::ReasoningEffort>,
