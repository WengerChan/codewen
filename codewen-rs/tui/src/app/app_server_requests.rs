...
mod tests {
    ...
    use codewen_app_server_protocol::McpElicitationObjectType;
    use codewen_app_server_protocol::McpElicitationSchema;
    ...
    use codewen_app_server_protocol::PermissionGrantScope;
    use codewen_app_server_protocol::PermissionsRequestApprovalParams;
    use codewen_app_server_protocol::PermissionsRequestApprovalResponse;
    use codewen_app_server_protocol::RequestId as AppServerRequestId;
    use codewen_app_server_protocol::ServerRequest;
    use codewen_app_server_protocol::ToolRequestUserInputAnswer;
    ...
    fn rejects_permissions_with_paths_that_cannot_be_localized() {
        ...
        let permissions = codewen_app_server_protocol::RequestPermissionProfile {
            network: None,
    ...
    fn resolves_permissions_and_user_input_through_app_server_request_id() {
        ...
        let permissions = pending
            .take_resolution(&Op::RequestPermissionsResponse {
                id: "perm-1".to_string(),
                response: codewen_protocol::request_permissions::RequestPermissionsResponse {
                    ...
                    scope: codewen_protocol::request_permissions::PermissionGrantScope::Session,
        ...
        assert_eq!(
            ...
            PermissionsRequestApprovalResponse {
                permissions: codewen_app_server_protocol::GrantedPermissionProfile {
                    ...
                    file_system: Some(AdditionalFileSystemPermissions {
                        ...
                        glob_scan_max_depth: None,
                        entries: Some(vec![
                            codewen_app_server_protocol::FileSystemSandboxEntry {
                                path: codewen_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(read_path).into(),
                                },
                                access: codewen_app_server_protocol::FileSystemAccessMode::Read,
                            },
                            codewen_app_server_protocol::FileSystemSandboxEntry {
                                path: codewen_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(write_path).into(),
                                },
                                access: codewen_app_server_protocol::FileSystemAccessMode::Write,
                            },
                        ]),
                    }),
                },
    ...
    fn rejects_dynamic_tool_calls_as_unsupported() {
        ...
        let unsupported = pending
            .note_server_request(&ServerRequest::DynamicToolCall {
                ...
                params: codewen_app_server_protocol::DynamicToolCallParams {
                    thread_id: "thread-1".to_string(),
                    turn_id: "turn-1".to_string(),
