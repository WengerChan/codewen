...
impl ThreadEventStore {
    ...
    pub(super) fn file_change_changes(
        ...
        turn_id: &str,
        item_id: &str,
    ) -> Option<Vec<codewen_app_server_protocol::FileUpdateChange>> {
        self.buffer
            .iter()
            .rev()
...
mod tests {
    ...
    use codewen_app_server_protocol::HookEventName as AppServerHookEventName;
    use codewen_app_server_protocol::HookExecutionMode as AppServerHookExecutionMode;
    use codewen_app_server_protocol::HookHandlerType as AppServerHookHandlerType;
    use codewen_app_server_protocol::HookOutputEntry as AppServerHookOutputEntry;
    use codewen_app_server_protocol::HookOutputEntryKind as AppServerHookOutputEntryKind;
    use codewen_app_server_protocol::HookRunStatus as AppServerHookRunStatus;
    use codewen_app_server_protocol::HookRunSummary as AppServerHookRunSummary;
    use codewen_app_server_protocol::HookScope as AppServerHookScope;
    use codewen_app_server_protocol::HookStartedNotification;
    use codewen_app_server_protocol::McpToolCallProgressNotification;
    ...
    fn thread_event_store_rebase_preserves_mcp_startup_notifications() {
        ...
        let notification = ServerNotification::McpServerStatusUpdated(
            codewen_app_server_protocol::McpServerStatusUpdatedNotification {
                thread_id: Some(thread_id.to_string()),
                name: "sentry".to_string(),
                status: codewen_app_server_protocol::McpServerStartupState::Failed,
