...
async fn start_recording_app_server(
    ...
    let embedded = crate::start_embedded_app_server(
        codewen_arg0::Arg0DispatchPaths::default(),
        config.clone(),
        Vec::new(),
        codewen_config::LoaderOverrides::default(),
        /*strict_config*/ false,
        codewen_config::CloudConfigBundleLoader::default(),
    ...
    .await?;
    let codewen_home = config.codewen_home.display().to_string();
                        ...
                        .send(Message::Text(
                            serde_json::to_string(&JSONRPCMessage::Response(JSONRPCResponse {
                                ...
                                result: serde_json::json!({
                                    "userAgent": "codewen-tui-test",
                                    "codexHome": codewen_home,
                                }),
                            }))?
                            .into(),
                        ))
