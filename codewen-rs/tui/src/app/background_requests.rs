    ...
    for status in statuses {
        ...
        auth_statuses.insert(
            ...
            match status.auth_status {
                codewen_app_server_protocol::McpAuthStatus::Unsupported => {
                    McpAuthStatus::Unsupported
                }
                codewen_app_server_protocol::McpAuthStatus::NotLoggedIn => {
                    McpAuthStatus::NotLoggedIn
                }
                codewen_app_server_protocol::McpAuthStatus::BearerToken => {
