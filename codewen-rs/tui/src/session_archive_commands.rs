//! Shared implementation for `codewen archive`, `codewen delete`, and `codewen unarchive`.
//!
...
async fn start_app_server_for_archive_command(
    ...
    let codewen_home = find_codewen_home().wrap_err("failed to find Codex home")?;
    ...
    let default_daemon = if explicit_remote_endpoint.is_none() && reuse_implicit_local_daemon {
        super::maybe_probe_default_daemon_socket(codewen_home.as_path()).await
    } else {
        None
    };
