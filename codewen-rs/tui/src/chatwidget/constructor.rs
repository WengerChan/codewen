...
impl ChatWidget {
    pub(crate) fn new_with_app_event(common: ChatWidgetInit) -> Self {
        Self::new_with_op_target(common, CodewenOpTarget::AppEvent)
    }
    ...
    pub(super) fn new_with_op_target(
        ...
        let mut widget = Self {
            ...
            codewen_rate_limit_reached_type: None,
            codewen_spend_control_reached: None,
        ...
        widget
            .bottom_pane
            .set_token_activity_command_enabled(widget.has_codewen_backend_auth);
