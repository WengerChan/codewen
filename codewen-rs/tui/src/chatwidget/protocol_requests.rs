...
impl ChatWidget {
    ...
    pub(super) fn on_guardian_review_notification(
        ...
        turn_id: String,
        started_at_ms: i64,
        review: codewen_app_server_protocol::GuardianApprovalReview,
        completion: Option<(i64, codewen_app_server_protocol::AutoReviewDecisionSource)>,
        ...
        self.on_guardian_assessment(GuardianAssessmentEvent {
            ...
            status: match review.status {
                codewen_app_server_protocol::GuardianApprovalReviewStatus::InProgress => {
                    GuardianAssessmentStatus::InProgress
                }
                codewen_app_server_protocol::GuardianApprovalReviewStatus::Approved => {
                    GuardianAssessmentStatus::Approved
                }
                codewen_app_server_protocol::GuardianApprovalReviewStatus::Denied => {
                    GuardianAssessmentStatus::Denied
                }
                codewen_app_server_protocol::GuardianApprovalReviewStatus::TimedOut => {
                    GuardianAssessmentStatus::TimedOut
                }
                codewen_app_server_protocol::GuardianApprovalReviewStatus::Aborted => {
                    GuardianAssessmentStatus::Aborted
                }
            },
            risk_level: review.risk_level.map(|risk_level| match risk_level {
                codewen_app_server_protocol::GuardianRiskLevel::Low => {
                    codewen_protocol::approvals::GuardianRiskLevel::Low
                }
                codewen_app_server_protocol::GuardianRiskLevel::Medium => {
                    codewen_protocol::approvals::GuardianRiskLevel::Medium
                }
                codewen_app_server_protocol::GuardianRiskLevel::High => {
                    codewen_protocol::approvals::GuardianRiskLevel::High
                }
                codewen_app_server_protocol::GuardianRiskLevel::Critical => {
                    codewen_protocol::approvals::GuardianRiskLevel::Critical
                }
            }),
            user_authorization: review.user_authorization.map(|user_authorization| {
                match user_authorization {
                    codewen_app_server_protocol::GuardianUserAuthorization::Unknown => {
                        codewen_protocol::approvals::GuardianUserAuthorization::Unknown
                    }
                    codewen_app_server_protocol::GuardianUserAuthorization::Low => {
                        codewen_protocol::approvals::GuardianUserAuthorization::Low
                    }
                    codewen_app_server_protocol::GuardianUserAuthorization::Medium => {
                        codewen_protocol::approvals::GuardianUserAuthorization::Medium
                    }
                    codewen_app_server_protocol::GuardianUserAuthorization::High => {
                        codewen_protocol::approvals::GuardianUserAuthorization::High
                    }
                }
            }),
            rationale: review.rationale,
            decision_source: decision_source.map(|source| match source {
                codewen_app_server_protocol::AutoReviewDecisionSource::Agent => {
