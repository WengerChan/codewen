...
use codewen_app_server_protocol::FileSystemAccessMode;
use codewen_app_server_protocol::FileSystemPath;
use codewen_app_server_protocol::FileSystemSandboxEntry;
use codewen_app_server_protocol::FileSystemSpecialPath;
use codewen_app_server_protocol::McpServerElicitationAction;
use codewen_app_server_protocol::NetworkApprovalContext;
use codewen_app_server_protocol::NetworkApprovalProtocol;
...
mod tests {
    ...
    use codewen_app_server_protocol::ExecPolicyAmendment;
    use codewen_app_server_protocol::NetworkApprovalProtocol;
    use codewen_app_server_protocol::NetworkPolicyAmendment;
    ...
    fn exec_history_cell_wraps_with_two_space_indent() {
        ...
        let rendered: Vec<String> = lines
            ...
            .collect();
        let expected = vec![
            "✔ You approved codewen to run".to_string(),
    ...
    fn network_access_command_history_uses_target_without_structured_context() {
        ...
        assert_eq!(
            ...
            vec![
                "✔ You approved codewen network access to https://example.com:8443 this time"
                    .to_string(),
            ]
        );
    }
