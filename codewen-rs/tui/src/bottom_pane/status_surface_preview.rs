...
impl StatusSurfacePreviewItem {
    fn placeholder(self) -> &'static str {
        match self {
            StatusSurfacePreviewItem::AppName => "codewen",
            ...
            StatusSurfacePreviewItem::CodewenVersion => "0.0.0",
            ...
            StatusSurfacePreviewItem::Model => "gpt-5.2-codewen",
            StatusSurfacePreviewItem::ModelWithReasoning => "gpt-5.2-codewen medium",
