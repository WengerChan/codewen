...
use codewen_otel::ORIGINATOR_TAG;
use codewen_otel::bounded_originator_tag_value;
use codewen_state::DbTelemetry;
use codewen_state::DbTelemetryHandle;
...
pub(crate) fn recorder(metrics: codewen_otel::MetricsClient, originator: &str) -> DbTelemetryHandle {
