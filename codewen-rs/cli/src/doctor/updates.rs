...
const GITHUB_LATEST_RELEASE_URL: &str = "https://api.github.com/repos/openai/codewen/releases/latest";
const HOMEBREW_CASK_API_URL: &str = "https://formulae.brew.sh/api/cask/codewen.json";
...
pub(super) fn updates_check(config: &Config) -> DoctorCheck {
    ...
    let version_file = config.codewen_home.join(VERSION_FILE_NAME);
...
fn update_action_label(context: &InstallContext) -> &'static str {
    match &context.method {
        InstallMethod::Npm => "npm install -g @openai/codewen",
        InstallMethod::Bun => "bun install -g @openai/codewen",
        InstallMethod::Pnpm => "pnpm add -g @openai/codewen",
        InstallMethod::Brew => "brew upgrade --cask codewen",
