...
pub use codewen_utils_path::is_wsl;
...
mod tests {
    ...
    fn win_to_wsl_basic() {
        assert_eq!(
            win_path_to_wsl(r"C:\Temp\codewen.zip").as_deref(),
            Some("/mnt/c/Temp/codewen.zip")
        );
        assert_eq!(
            win_path_to_wsl("D:/Work/codewen.tgz").as_deref(),
            Some("/mnt/d/Work/codewen.tgz")
        );
        assert!(win_path_to_wsl("/home/user/codewen").is_none());
    }
