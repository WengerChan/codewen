...
fn retry_uses_original_unified_exec_request_and_stops_after_second_failure() {
    ...
    let request = RunnerTransportRequest {
        ...
        codewen_home: PathBuf::from(r"C:\Users\codewen"),
        cwd: PathBuf::from(r"C:\workspace"),
        env_map: env_map.clone(),
        logs_base_dir: Some(PathBuf::from(r"C:\Users\codewen\.sandbox")),
        spawn_request: SpawnRequest {
            ...
            codewen_home: PathBuf::from(r"C:\Users\codewen\.sandbox"),
            real_codewen_home: PathBuf::from(r"C:\Users\codewen"),
        ...
        deny_write_paths_override: vec![PathBuf::from(r"C:\workspace\.codewen")],
        proxy_enforced: true,
    ...
    let expected_refresh = RefreshObservation {
        ...
        env_map,
        codewen_home: request.codewen_home.clone(),
    ...
    let result = spawn_runner_transport_with_retry(
        ...
        &request,
        |codewen_home, cwd, sandbox_creds, logs_base_dir, spawn_request| {
