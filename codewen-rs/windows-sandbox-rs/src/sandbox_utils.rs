...
//! codewen home directory creation and git safe.directory injection so sandboxed
...
/// Ensure the sandbox codewen home directory exists.
pub fn ensure_codewen_home_exists(p: &Path) -> Result<()> {
