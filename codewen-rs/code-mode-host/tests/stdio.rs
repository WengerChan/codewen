...
use codewen_code_mode::CodeModeSessionDelegate;
use codewen_code_mode::CodeModeSessionProvider;
use codewen_code_mode::CodeModeToolKind;
use codewen_code_mode::ExecuteRequest;
use codewen_code_mode::FunctionCallOutputContentItem;
use codewen_code_mode::NotificationFuture;
use codewen_code_mode::ProcessOwnedCodeModeSessionProvider;
use codewen_code_mode::RuntimeResponse;
use codewen_code_mode::ToolDefinition;
use codewen_code_mode::ToolInvocationFuture;
use codewen_code_mode::WaitOutcome;
use codewen_code_mode::WaitRequest;
use codewen_code_mode::host::MAX_FRAME_BYTES;
...
async fn remote_session_persists_values_forwards_delegates_and_controls_cells() {
    let provider = ProcessOwnedCodeModeSessionProvider::with_host_program(
        codewen_utils_cargo_bin::cargo_bin("codewen-code-mode-host").expect("host binary"),
    );
