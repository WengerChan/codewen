...
use codewen_config::SkillsConfig;
...
impl SkillsService {
    pub fn new(codewen_home: AbsolutePathBuf, bundled_skills_enabled: bool) -> Self {
        Self::new_with_restriction_product(codewen_home, bundled_skills_enabled, Some(Product::Codex))
    }
    ...
    pub fn new_with_restriction_product(
        ...
        if !bundled_skills_enabled {
            ...
            uninstall_system_skills(&service.codewen_home);
        } else if let Err(err) = install_system_skills(&service.codewen_home) {
...
pub fn bundled_skills_enabled_from_stack(
    config_layer_stack: &codewen_config::ConfigLayerStack,
) -> bool {
