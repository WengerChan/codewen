...
use codewen_connectors::PluginConnectorSource;
...
use codewen_extension_api::McpServerContribution;
use codewen_extension_api::McpServerContributionContext;
use codewen_login::CodewenAuth;
use codewen_mcp::CODEX_APPS_MCP_SERVER_NAME;
use codewen_mcp::EffectiveMcpServer;
use codewen_mcp::McpConfig;
use codewen_mcp::McpPluginAttribution;
use codewen_mcp::McpServerRegistration;
use codewen_mcp::McpToolCatalogCache;
use codewen_mcp::ToolInfo;
use codewen_mcp::codewen_apps_mcp_server_config;
use codewen_mcp::configured_mcp_servers;
...
const LEGACY_CODEX_APPS_REGISTRATION_ID: &str = "legacy_codewen_apps";
...
impl McpManager {
    pub fn new(plugins_manager: Arc<PluginsManager>) -> Self {
        Self::new_with_extensions(
            plugins_manager,
            codewen_extension_api::empty_extension_registry(),
    ...
    pub fn codewen_apps_tools_cache(&self) -> ConnectorRuntimeManager<ToolInfo> {
        self.codewen_apps_tools_cache.clone()
    }
