...
use codewen_protocol::protocol::GuardianAssessmentAction;
...
use codewen_protocol::request_user_input::RequestUserInputEvent;
...
async fn forward_ops_preserves_submission_trace_context() {
    ...
    let submission = Submission {
        ...
        trace: Some(codewen_protocol::protocol::W3cTraceContext {
            traceparent: Some(
...
#[tokio::test]
async fn run_codewen_thread_interactive_respects_pre_cancelled_spawn() {
    ...
    let result = timeout(
        ...
        run_codewen_thread_interactive(
    ...
    assert!(matches!(result, Err(CodewenErr::TurnAborted)));
}
