...
/// `codewen_feedback::CodewenFeedback::metadata_layer()` is installed, these fields are captured and
...
///
/// codewen_core::feedback_tags!(model = "gpt-5", cached = true);
/// codewen_core::feedback_tags!(provider = provider_id, request_id = request_id);
/// ```
#[macro_export]
