    ...
    async fn reserve_slot(
        ...
        loop {
            ...
            if !self
                ...
                .await
            {
                return Err(CodewenErr::AgentLimitReached {
...
fn is_resident_candidate(thread: &CodewenThread) -> bool {
...
async fn is_unloadable(thread: &CodewenThread) -> bool {
    matches!(
