...
fn exec_server_env_for_request(
    ...
    Option<codewen_exec_server::ExecEnvPolicy>,
    HashMap<String, String>,
) {
...
fn exec_server_params_for_request(
    ...
    request: &ExecRequest,
    tty: bool,
) -> codewen_exec_server::ExecParams {
...
impl UnifiedExecProcessManager {
    ...
    pub(crate) async fn open_session_with_exec_env(
        ...
        network_proxy_launch: Option<codewen_network_proxy::RemoteNetworkProxyLaunchConfig>,
        ...
        .map_err(|err| match err {
            UnifiedExecError::SandboxDenied { output, .. } => {
                ToolError::Codex(CodewenErr::Sandbox(SandboxErr::Denied {
    ...
    pub(crate) async fn open_session_with_prepared_exec_env(
        ...
        let network_proxy_restricting_sid = {
            ...
            {
                if request.sandbox == codewen_sandboxing::SandboxType::WindowsRestrictedToken {
                    request
                        .network
                        .as_ref()
                        .map(|network| {
        ...
        let windows_sandbox = if request.sandbox
            == codewen_sandboxing::SandboxType::WindowsRestrictedToken
        {
            Some(codewen_sandboxing::WindowsSandboxSpawnRequest {
                ...
                proxy_settings_mode: codewen_sandboxing::WindowsSandboxProxySettingsMode::Reconcile,
        ...
        let spawn_result = codewen_sandboxing::spawn_process(codewen_sandboxing::SpawnRequest {
    ...
    pub(super) async fn open_session_with_sandbox(
        ...
        orchestrator
            ...
            .map_err(|err| match err {
                ToolError::Codex(CodewenErr::Sandbox(SandboxErr::Denied { output, .. })) => {
                    let output = *output;
