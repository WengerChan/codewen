...
use codewen_config::permissions_toml::NetworkUnixSocketPermissionToml;
use codewen_config::permissions_toml::NetworkUnixSocketPermissionsToml;
...
use codewen_features::NetworkProxyDomainPermissionToml;
use codewen_features::NetworkProxyModeToml;
use codewen_features::NetworkProxyUnixSocketPermissionToml;
use codewen_network_proxy::NetworkMode;
use codewen_network_proxy::NetworkProxyConfig;
#[cfg(test)]
use codewen_network_proxy::NetworkUnixSocketPermission as ProxyNetworkUnixSocketPermission;
...
use codewen_protocol::permissions::project_roots_glob_pattern;
...
pub(crate) fn get_readable_roots_required_for_codewen_runtime(
    codewen_home: &Path,
    zsh_path: Option<&PathBuf>,
    main_execve_wrapper_exe: Option<&PathBuf>,
) -> Vec<AbsolutePathBuf> {
    let arg0_root = AbsolutePathBuf::from_absolute_path(codewen_home.join("tmp").join("arg0")).ok();
