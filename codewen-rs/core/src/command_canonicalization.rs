use codewen_shell_command::bash::extract_bash_command;
use codewen_shell_command::bash::parse_shell_lc_plain_commands;
use codewen_shell_command::powershell::extract_powershell_command;

const CANONICAL_BASH_SCRIPT_PREFIX: &str = "__codewen_shell_script__";
const CANONICAL_POWERSHELL_SCRIPT_PREFIX: &str = "__codewen_powershell_script__";
