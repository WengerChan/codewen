...
use codewen_tools::LoadableToolSpec;
use codewen_tools::TOOL_SEARCH_DEFAULT_LIMIT;
use codewen_tools::TOOL_SEARCH_TOOL_NAME;
use codewen_tools::ToolName;
use codewen_tools::ToolSearchEntry;
use codewen_tools::ToolSearchInfo;
use codewen_tools::ToolSpec;
use codewen_tools::coalesce_loadable_tool_specs;
use std::sync::Arc;
use std::sync::Mutex;
...
mod tests {
    ...
    fn mixed_search_results_coalesce_mcp_namespaces() {
        let dynamic_namespace = DynamicToolNamespaceSpec {
            ...
            description: "Tools in the codewen_app namespace.".to_string(),
            tools: Vec::new(),
        };
