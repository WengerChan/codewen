...
impl ExecCommandHandler {
    async fn handle_call(
        ...
        let command_for_display = codewen_shell_command::parse_command::shlex_join(&command);
        ...
        if effective_additional_permissions
            ...
            && !matches!(
                ...
                codewen_protocol::protocol::AskForApproval::OnRequest
            )
        {
