...
) -> codewen_tools::ToolUserShellType {
    match user_shell.shell_type {
        crate::shell::ShellType::Zsh => codewen_tools::ToolUserShellType::Zsh,
        crate::shell::ShellType::Bash => codewen_tools::ToolUserShellType::Bash,
        crate::shell::ShellType::PowerShell => codewen_tools::ToolUserShellType::PowerShell,
        crate::shell::ShellType::Sh => codewen_tools::ToolUserShellType::Sh,
        crate::shell::ShellType::Cmd => codewen_tools::ToolUserShellType::Cmd,
    }
}
