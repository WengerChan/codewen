...
pub(crate) use codewen_network_proxy::is_managed_proxy_env_var;
pub(crate) use codewen_network_proxy::strip_managed_proxy_env;
...
fn build_proxy_env_exports() -> (String, String) {
    ...
    let git_blocks = build_codewen_proxy_git_ssh_command_exports();
    (
...
#[cfg(target_os = "macos")]
fn build_codewen_proxy_git_ssh_command_exports() -> (String, String) {
