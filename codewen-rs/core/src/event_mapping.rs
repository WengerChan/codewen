...
use codewen_protocol::items::WebSearchItem;
...
use codewen_protocol::models::is_audio_close_tag_text;
use codewen_protocol::models::is_audio_open_tag_text;
use codewen_protocol::models::is_image_close_tag_text;
use codewen_protocol::models::is_image_open_tag_text;
use codewen_protocol::models::is_local_audio_close_tag_text;
use codewen_protocol::models::is_local_audio_open_tag_text;
use codewen_protocol::models::is_local_image_close_tag_text;
use codewen_protocol::models::is_local_image_open_tag_text;
use codewen_protocol::protocol::APPS_INSTRUCTIONS_OPEN_TAG;
use codewen_protocol::protocol::COLLABORATION_MODE_OPEN_TAG;
use codewen_protocol::protocol::CONTEXT_WINDOW_GUIDANCE_OPEN_TAG;
use codewen_protocol::protocol::CONTEXT_WINDOW_OPEN_TAG;
use codewen_protocol::protocol::ENVIRONMENTS_INSTRUCTIONS_OPEN_TAG;
use codewen_protocol::protocol::MULTI_AGENT_MODE_OPEN_TAG;
use codewen_protocol::protocol::PLUGINS_INSTRUCTIONS_OPEN_TAG;
use codewen_protocol::protocol::REALTIME_CONVERSATION_OPEN_TAG;
...
pub fn parse_turn_item(item: &ResponseItem) -> Option<TurnItem> {
    match item {
        ...
        ResponseItem::ImageGenerationCall {
            ...
            codewen_protocol::items::ImageGenerationItem {
