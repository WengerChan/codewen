...
pub const CODEX_SANDBOX_NETWORK_DISABLED_ENV_VAR: &str = "CODEWEN_SANDBOX_NETWORK_DISABLED";
...
pub const CODEX_SANDBOX_ENV_VAR: &str = "CODEWEN_SANDBOX";
    ...
    unsafe {
        ...
        cmd.pre_exec(move || {
            ...
            #[cfg(target_os = "linux")]
            {
                ...
                // current parent dies."
                codewen_utils_pty::process_group::set_parent_death_signal(parent_pid)?;
            }
            Ok(())
        });
    }
