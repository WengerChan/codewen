...
use codewen_protocol::mcp::RequestId as ProtocolRequestId;
...
pub async fn resolve_elicitation(
    ...
    decision: codewen_protocol::approvals::ElicitationAction,
    content: Option<Value>,
    meta: Option<Value>,
) {
    let action = match decision {
        codewen_protocol::approvals::ElicitationAction::Accept => ElicitationAction::Accept,
        codewen_protocol::approvals::ElicitationAction::Decline => ElicitationAction::Decline,
        codewen_protocol::approvals::ElicitationAction::Cancel => ElicitationAction::Cancel,
    };
...
async fn emit_thread_stop_lifecycle(sess: &Session) {
    for contributor in sess.services.extensions.thread_lifecycle_contributors() {
        contributor
            .on_thread_stop(codewen_extension_api::ThreadStopInput {
...
pub async fn shutdown(sess: &Arc<Session>, sub_id: String) -> bool {
    ...
    sess.services.session_telemetry.counter(
        "codewen.conversation.turn.count",
    ...
    sess.services
        .rollout_thread_trace
        .record_ended(codewen_rollout_trace::RolloutStatus::Completed);
    true
}
