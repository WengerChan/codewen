...
use codewen_file_system::FileSystemSandboxContext;
...
use codewen_sandboxing::policy_transforms::effective_network_sandbox_policy;
...
pub struct TurnContext {
    ...
    pub(crate) extension_data: Arc<codewen_extension_api::ExtensionData>,
...
impl TurnContext {
    ...
    pub(crate) fn apps_enabled(&self) -> bool {
        let uses_codewen_backend = self
            .auth_manager
            .as_deref()
            .is_some_and(AuthManager::current_auth_uses_codewen_backend);
        self.config
            .features
            .apps_enabled_for_auth(uses_codewen_backend)
...
impl Session {
    ...
    pub(crate) fn make_turn_context(
        ...
        let unified_exec_shell_mode = UnifiedExecShellMode::for_session(
            codewen_tools::unified_exec_feature_mode_for_features(per_turn_config.features.get()),
        ...
        let extension_data = Arc::new(codewen_extension_api::ExtensionData::new(sub_id.clone()));
    ...
    ) -> CodewenResult<Arc<TurnContext>> {
        let notify_config_contributors = !self.services.extensions.config_contributors().is_empty();
        let update_result: CodewenResult<_> = {
            ...
            match state.session_configuration.clone().apply(&updates) {
                ...
                Err(err) => Err(CodewenErr::InvalidRequest(err.to_string())),
            }
        };
        ...
        let (session_configuration, permission_profile_changed, previous_config, new_config) =
            match update_result {
                ...
                Err(err) => {
                    ...
                    .await;
                    return Err(CodewenErr::InvalidRequest(message));
                }
            };
