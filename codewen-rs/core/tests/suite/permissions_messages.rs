...
use codewen_core::context::ApprovalPromptContext;
use codewen_core::context::ContextualUserFragment;
use codewen_core::context::PermissionsInstructions;
use codewen_core::load_exec_policy;
use codewen_models_manager::model_info::model_info_from_slug;
use codewen_protocol::models::PermissionProfile;
use codewen_protocol::openai_models::ApprovalMessages;
use codewen_protocol::openai_models::ModelMessages;
use codewen_protocol::openai_models::ModelsResponse;
use codewen_protocol::openai_models::PermissionMessages;
...
) -> codewen_protocol::openai_models::ModelInfo {
