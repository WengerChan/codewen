...
async fn ultra_reasoning_uses_max_and_proactive_mode() -> Result<()> {
    ...
    submit_turn(&test.codewen, "hello", /*effort*/ None).await?;
...
async fn configured_mode_hint_uses_custom_mode_across_reasoning_efforts() -> Result<()> {
    ...
    submit_turn(&test.codewen, "explicit", Some(ReasoningEffort::High)).await?;
    submit_turn(&test.codewen, "proactive", Some(ReasoningEffort::Ultra)).await?;
...
async fn empty_configured_mode_hint_emits_no_mode_message() -> Result<()> {
    ...
    submit_turn(&test.codewen, "hello", Some(ReasoningEffort::High)).await?;
...
async fn changing_configured_mode_hint_to_empty_emits_no_update() -> Result<()> {
    ...
    submit_turn(&initial.codewen, "before resume", /*effort*/ None).await?;
    drop(initial);
    ...
    submit_turn(&resumed.codewen, "after resume", /*effort*/ None).await?;
