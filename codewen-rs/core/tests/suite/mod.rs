...
// It allows the test binary to behave like codewen and dispatch to apply_patch and codewen-linux-sandbox
// based on the arg0.
// NOTE: this doesn't work on ARM
#[ctor]
pub static CODEX_ALIASES_TEMP_DIR: Option<TestBinaryDispatchGuard> = {
    configure_test_binary_dispatch("codewen-core-tests", |exe_name, argv1| {
