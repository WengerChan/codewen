use crate::test_codewen::TestCodexBuilder;
use crate::test_codewen::test_codewen;
use anyhow::Result;
...
const CODEX_APPS_META_KEY: &str = "_codewen_apps";
const CODEX_APPS_MCP_PATH_REGEX: &str = "^/api/codewen/ps/mcp/?$";
const HOSTED_PLUGIN_RUNTIME_MCP_PATH_REGEX: &str = "^/api/codewen/ps/mcp/?$";
const PROTOCOL_VERSION: &str = "2025-11-25";
const SERVER_NAME: &str = "codewen-apps-test";
...
pub const DIRECT_CALENDAR_CREATE_EVENT_TOOL: &str = "mcp__codewen_apps__calendar__create_event";
pub const DIRECT_CALENDAR_APP_ONLY_TOOL: &str = "mcp__codewen_apps__calendar__app_only_action";
pub const DIRECT_CALENDAR_LIST_EVENTS_TOOL: &str = "mcp__codewen_apps__calendar__list_events";
pub const DIRECT_CALENDAR_EXTRACT_TEXT_TOOL: &str = "mcp__codewen_apps__calendar__extract_text";
pub const SEARCH_CALENDAR_NAMESPACE: &str = "mcp__codewen_apps__calendar";
...
pub async fn recorded_apps_tool_calls(server: &MockServer) -> Vec<Value> {
    server
        ...
        .filter_map(|request| {
            ...
            (request.url.path() == "/api/codewen/ps/mcp"
...
async fn mount_streamable_http_json_rpc_with_startup_control(
    ...
    Mock::given(method("POST"))
        ...
        .respond_with(CodewenAppsJsonRpcResponder {
            connector_name,
            connector_description,
            searchable,
            include_app_only_tool,
...
struct CodewenAppsJsonRpcResponder {
    connector_name: String,
    connector_description: String,
    searchable: bool,
    include_app_only_tool: bool,
...
impl Respond for CodewenAppsJsonRpcResponder {
        ...
        match method {
            ...
            "tools/call" => {
                ...
                let file_id = body
                    ...
                    .and_then(Value::as_str)
                    .unwrap_or_default();
                let codewen_apps_meta = body.pointer("/params/_meta/_codewen_apps").cloned();
                ...
                ResponseTemplate::new(200).set_body_json(json!({
                    ...
                    "result": {
                        ...
                        "structuredContent": {
                            "_codewen_apps": codewen_apps_meta,
                        },
                        "isError": false
                    }
                }))
