...
impl<T: HttpTransport> ModelsClient<T> {
    ...
    fn append_client_version_query(req: &mut codewen_client::Request, client_version: &str) {
...
mod tests {
    ...
    async fn appends_client_version_query() {
        ...
        let provider = provider("https://example.com/api/codewen");
        ...
        assert_eq!(
            url,
            "https://example.com/api/codewen/models?client_version=0.99.0"
        );
    }
