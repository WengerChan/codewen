...
use codewen_exec_server::FsCloseParams;
use codewen_exec_server::FsOpenParams;
use codewen_exec_server::FsReadBlockParams;
use codewen_exec_server::FsReadBlockResponse;
use codewen_exec_server::RemoteExecServerConnectArgs;
...
async fn file_reads_reject_named_pipes() -> Result<()> {
    ...
    let read_path = format!(r"\\.\pipe\codewen-fs-read-{}", Uuid::new_v4());
    ...
    let stream_path = format!(r"\\.\pipe\codewen-fs-stream-{}", Uuid::new_v4());
