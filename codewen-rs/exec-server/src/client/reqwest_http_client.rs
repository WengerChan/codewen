...
use codewen_http_client::build_reqwest_client_with_custom_ca;
use codewen_http_client::with_chatgpt_cloudflare_cookie_store;
...
impl ReqwestHttpRequestRunner {
    ...
    ) -> Result<(HttpRequestResponse, Option<PendingReqwestHttpBodyStream>), JSONRPCErrorError>
    {
        ...
        let request_span = tracing::info_span!(
            "codewen.exec_server.http_request",
            otel.kind = "client",
        ...
        codewen_otel::inject_span_w3c_trace_headers(&request_span, &mut headers);
