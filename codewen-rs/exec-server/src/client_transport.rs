...
const ENVIRONMENT_CLIENT_NAME: &str = "codewen-environment";
...
impl ExecServerClient {
    ...
    #[tracing::instrument(
        name = "codewen.exec_server.remote.harness.connect",
        skip_all,
        fields(
            otel.kind = "client",
            otel.name = "codewen.exec_server.remote.harness.connect",
        )
    )]
