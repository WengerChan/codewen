...
pub type LoadedPlugin = codewen_plugin::LoadedPlugin<codewen_config::McpServerConfig>;
pub type PluginLoadOutcome = codewen_plugin::PluginLoadOutcome<codewen_config::McpServerConfig>;
