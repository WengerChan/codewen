pub use codewen_backend_openapi_models::models::ConfigBundleResponse;
pub use codewen_backend_openapi_models::models::CreditStatusDetails;
pub use codewen_backend_openapi_models::models::DeliveredConfigToml;
pub use codewen_backend_openapi_models::models::DeliveredManagedLayers;
pub use codewen_backend_openapi_models::models::DeliveredRequirementsToml;
pub use codewen_backend_openapi_models::models::DeliveredTomlFragment;
pub use codewen_backend_openapi_models::models::PaginatedListTaskListItem;
pub use codewen_backend_openapi_models::models::PlanType;
pub use codewen_backend_openapi_models::models::RateLimitReachedKind;
pub use codewen_backend_openapi_models::models::RateLimitStatusDetails;
pub use codewen_backend_openapi_models::models::RateLimitStatusPayload;
pub use codewen_backend_openapi_models::models::RateLimitWindowSnapshot;
pub use codewen_backend_openapi_models::models::SpendControlLimitDetails;
pub use codewen_backend_openapi_models::models::TaskListItem;
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct CodewenWorkspaceMessagesResponse {
    #[serde(default)]
    pub messages: Vec<CodewenWorkspaceMessage>,
}

/// Authenticated Codex user settings used by CLI runtime policy.
#[derive(Clone, Copy, Debug, Default, Deserialize, PartialEq, Eq)]
pub struct CodewenUserSettingsResponse {
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct CodewenWorkspaceMessage {
    pub message_id: String,
    pub message_type: CodewenWorkspaceMessageType,
...
#[derive(Clone, Copy, Debug, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum CodewenWorkspaceMessageType {
    Headline,
    Announcement,
    #[serde(other)]
    Unknown,
...
Second line"
    ...
    fn workspace_messages_response_deserializes_messages() {
        ...
        assert_eq!(
            response,
            CodewenWorkspaceMessagesResponse {
                messages: vec![
                    CodewenWorkspaceMessage {
                        message_id: "headline-id".to_string(),
                        message_type: CodewenWorkspaceMessageType::Headline,
                    ...
                    CodewenWorkspaceMessage {
                        ...
                        message_type: CodewenWorkspaceMessageType::Announcement,
                    ...
                    CodewenWorkspaceMessage {
                        ...
                        message_type: CodewenWorkspaceMessageType::Unknown,
