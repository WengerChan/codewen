...
- This repo’s scaffold writes `.codewen-plugin/plugin.json`; treat that as the manifest location this skill generates.
...
- `plugins` (`array`): Ordered plugin entries. This order determines how Codewen renders plugins.
