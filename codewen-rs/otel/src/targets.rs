pub(crate) const OTEL_TARGET_PREFIX: &str = "codewen_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "codewen_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "codewen_otel.trace_safe";
