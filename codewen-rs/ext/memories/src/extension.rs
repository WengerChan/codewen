...
pub(crate) struct MemoriesExtensionConfig {
    ...
    pub(crate) codewen_home: AbsolutePathBuf,
}
...
impl ContextContributor for MemoriesExtension {
    fn contribute_thread_context<'a>(
        ...
        Box::pin(async move {
            ...
            build_memory_tool_developer_instructions(&config.codewen_home)
                .await
...
impl ToolContributor for MemoriesExtension {
    fn tools(
        ...
        tools::memory_tools(
            LocalMemoriesBackend::from_codewen_home(&config.codewen_home),
