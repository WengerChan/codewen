...
use codewen_extension_api::ApprovalReviewContributor;
use codewen_extension_api::ConfigContributor;
use codewen_extension_api::ContextContributor;
use codewen_extension_api::ContextualUserFragment;
...
use codewen_extension_api::SkillInvocationContributor;
...
use codewen_extension_api::TurnInputContributor;
use codewen_extension_api::TurnItemContributor;
use codewen_extension_api::TurnLifecycleContributor;
use codewen_extension_api::empty_extension_registry;
use codewen_protocol::items::HookPromptItem;
        ...
        fragments.extend(
            contributor
                .contribute_turn_context(TurnContextContributionInput {
                    thread_id: codewen_protocol::ThreadId::default(),
