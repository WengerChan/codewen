...
use codewen_mcp::hosted_plugin_runtime_mcp_server_config;
...
impl McpServerContributor<Config> for HostedPluginRuntimeExtension {
    ...
    fn contribute<'a>(
        ...
        Box::pin(async move {
            ...
            if !config.features.enabled(codewen_features::Feature::Apps) {
...
pub fn install_executor_plugins(
    ...
    environment_manager: std::sync::Arc<codewen_exec_server::EnvironmentManager>,
) {
