...
use codewen_core_plugins::manifest::parse_plugin_manifest_uri;
use codewen_exec_server::CapabilityRootDiscovery;
use codewen_mcp::parse_executor_plugin_mcp_config;
...
fn parse_mcp_servers(
    selected_root: &SelectedCapabilityRoot,
    plugin_root: &codewen_utils_path_uri::PathUri,
    contents: &str,
    environment_id: &str,
) -> Vec<(String, codewen_config::McpServerConfig)> {
