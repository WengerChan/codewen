use codewen_core_skills::AvailableSkills;
use codewen_core_skills::SKILLS_HOW_TO_USE_WITH_ABSOLUTE_PATHS;
use codewen_core_skills::SKILLS_HOW_TO_USE_WITH_ALIASES;
use codewen_core_skills::render_available_skills_body;
