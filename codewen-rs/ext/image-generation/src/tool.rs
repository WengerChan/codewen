...
use codewen_extension_api::parse_tool_input_schema;
...
use codewen_utils_image::PromptImageMode;
use codewen_utils_image::load_for_prompt_bytes;
...
use crate::backend::CodewenImagesBackend;
...
impl ToolExecutor<ToolCall> for ImageGenerationTool {
    ...
    fn handle(&self, call: ToolCall) -> codewen_extension_api::ToolExecutorFuture<'_> {
