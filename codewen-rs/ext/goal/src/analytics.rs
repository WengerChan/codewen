...
use codewen_analytics::CodewenGoalEvent;
use codewen_analytics::GoalEventKind;
...
impl GoalAnalytics {
    ...
    pub(crate) fn cleared(&self, goal: &codewen_state::ThreadGoal) {
    ...
    fn track(
        ...
        self.client.track_goal_event(CodewenGoalEvent {
