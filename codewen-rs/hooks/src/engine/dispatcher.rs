...
pub(crate) fn completed_summary(
    ...
    entries: Vec<codewen_protocol::protocol::HookOutputEntry>,
) -> HookRunSummary {
    HookRunSummary {
        id: handler.run_id(),
        event_name: handler.event_name,
...
pub(crate) fn hook_source_label(source: codewen_protocol::protocol::HookSource) -> &'static str {
    match source {
        codewen_protocol::protocol::HookSource::System => "system",
        codewen_protocol::protocol::HookSource::User => "user",
        codewen_protocol::protocol::HookSource::Project => "project",
        codewen_protocol::protocol::HookSource::Mdm => "mdm",
        codewen_protocol::protocol::HookSource::SessionFlags => "session_flags",
        codewen_protocol::protocol::HookSource::Plugin => "plugin",
        codewen_protocol::protocol::HookSource::CloudRequirements => "cloud_requirements",
        codewen_protocol::protocol::HookSource::CloudManagedConfig => "cloud_managed_config",
