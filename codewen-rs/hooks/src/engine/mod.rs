...
pub(crate) struct ConfiguredHandler {
    pub event_name: codewen_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            codewen_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            codewen_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            codewen_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            codewen_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            codewen_protocol::protocol::HookEventName::PostCompact => "post-compact",
            codewen_protocol::protocol::HookEventName::SessionStart => "session-start",
            codewen_protocol::protocol::HookEventName::SessionEnd => "session-end",
            codewen_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
            codewen_protocol::protocol::HookEventName::SubagentStart => "subagent-start",
            codewen_protocol::protocol::HookEventName::SubagentStop => "subagent-stop",
            codewen_protocol::protocol::HookEventName::Stop => "stop",
        }
    }
}
...
impl ClaudeHooksEngine {
    ...
    async fn maybe_spill_prompt_fragments(
        &self,
        session_id: ThreadId,
        fragments: Vec<codewen_protocol::items::HookPromptFragment>,
    ) -> Vec<codewen_protocol::items::HookPromptFragment> {
        self.output_spiller
