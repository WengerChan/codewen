use anyhow::Context;
use anyhow::Result;
use codewen_app_server_protocol::generate_json_with_experimental;
use codewen_app_server_protocol::generate_typescript_schema_fixture_subtree_for_tests;
use codewen_app_server_protocol::read_schema_fixture_subtree;
...
fn schema_root() -> Result<PathBuf> {
    ...
    let json_root = json_bundle
        .parent()
        .and_then(|p| p.parent())
        .context("derive schema root from schema/json/codewen_app_server_protocol.schemas.json")?;
    anyhow::ensure!(
