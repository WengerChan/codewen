...
fn main() -> Result<()> {
    ...
    codewen_app_server_protocol::generate_ts_with_options(
        ...
        codewen_app_server_protocol::GenerateTsOptions {
            experimental_api: args.experimental,
            ..codewen_app_server_protocol::GenerateTsOptions::default()
        },
    )?;
    codewen_app_server_protocol::generate_json_with_experimental(&args.out_dir, args.experimental)
}
