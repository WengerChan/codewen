...
use codewen_protocol::protocol::CreditsSnapshot as CoreCreditsSnapshot;
use codewen_protocol::protocol::RateLimitReachedType as CoreRateLimitReachedType;
use codewen_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use codewen_protocol::protocol::RateLimitWindow as CoreRateLimitWindow;
use codewen_protocol::protocol::SpendControlLimitSnapshot as CoreSpendControlLimitSnapshot;
...
pub enum Account {
    ...
    AmazonBedrock {
        #[serde(default)]
        uses_codewen_managed_credentials: bool,
    },
}
    ...
    fn from(account: ProviderAccount) -> Self {
        match account {
            ...
            ProviderAccount::AmazonBedrock {
                uses_codewen_managed_credentials,
            } => Self::AmazonBedrock {
                uses_codewen_managed_credentials,
            },
        }
...
pub struct GetAccountRateLimitsResponse {
    ...
    /// Multi-bucket view keyed by metered `limit_id` (for example, `codewen`).
