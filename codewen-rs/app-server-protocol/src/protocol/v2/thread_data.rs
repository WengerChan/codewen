...
use codewen_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use codewen_protocol::protocol::ThreadHistoryMode as CoreThreadHistoryMode;
use codewen_protocol::protocol::ThreadSource as CoreThreadSource;
...
pub struct Thread {
    ...
    /// Origin of the thread (CLI, VSCode, codewen exec, codewen app-server, etc.).
