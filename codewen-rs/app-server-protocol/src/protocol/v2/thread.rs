...
pub use codewen_protocol::capabilities::CapabilityRootLocation;
pub use codewen_protocol::capabilities::SelectedCapabilityRoot;
...
use codewen_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use codewen_protocol::protocol::TokenUsage as CoreTokenUsage;
use codewen_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
pub struct ThreadStartParams {
    ...
    #[serde(
        default,
        deserialize_with = "codewen_protocol::dynamic_tools::deserialize_dynamic_tool_specs"
    )]
    #[ts(optional = nullable)]
...
impl From<codewen_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: codewen_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> codewen_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => codewen_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => codewen_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `codewen_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
