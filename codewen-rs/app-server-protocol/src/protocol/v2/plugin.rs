...
use codewen_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use codewen_protocol::protocol::SkillInterface as CoreSkillInterface;
use codewen_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use codewen_protocol::protocol::SkillScope as CoreSkillScope;
use codewen_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
