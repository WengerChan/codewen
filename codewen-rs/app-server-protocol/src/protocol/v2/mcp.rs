...
use codewen_protocol::items::McpToolCallError as CoreMcpToolCallError;
use codewen_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use codewen_protocol::mcp::McpServerInfo;
use codewen_protocol::mcp::Resource as McpResource;
pub use codewen_protocol::mcp::ResourceContent as McpResourceContent;
use codewen_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use codewen_protocol::mcp::Tool as McpTool;
...
v2_enum_from_core!(
    pub enum McpAuthStatus from codewen_protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
v2_enum_from_core!(
    pub enum McpServerStartupFailureReason from codewen_protocol::protocol::McpStartupFailureReason {
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> codewen_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => codewen_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => codewen_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => codewen_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
