...
use codewen_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use codewen_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use codewen_protocol::user_input::ByteRange as CoreByteRange;
use codewen_protocol::user_input::TextElement as CoreTextElement;
...
pub struct TurnStartParams {
    ...
    /// `client_metadata["x-codewen-turn-metadata"]` on ResponsesAPI HTTP and websocket requests.
    ///
