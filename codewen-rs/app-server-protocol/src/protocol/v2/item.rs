...
use codewen_experimental_api_macros::ExperimentalApi;
use codewen_extension_items::ExtensionItem;
pub use codewen_extension_items::image_generation::ImageGenerationItem;
pub use codewen_extension_items::sleep::SleepItem;
pub use codewen_extension_items::web_search::WebSearchAction;
pub use codewen_extension_items::web_search::WebSearchItem;
use codewen_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use codewen_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use codewen_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
use codewen_protocol::items::AgentMessageContent as CoreAgentMessageContent;
...
use codewen_protocol::parse_command::ParsedCommand as CoreParsedCommand;
...
use codewen_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use codewen_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use codewen_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use codewen_protocol::protocol::ReviewDecision as CoreReviewDecision;
...
pub(crate) fn web_search_action_from_core(
    value: codewen_protocol::models::WebSearchAction,
) -> WebSearchAction {
    match value {
        codewen_protocol::models::WebSearchAction::Search { query, queries } => {
            WebSearchAction::Search { query, queries }
        }
        codewen_protocol::models::WebSearchAction::OpenPage { url } => {
            WebSearchAction::OpenPage { url }
        }
        codewen_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
            WebSearchAction::FindInPage { url, pattern }
        }
        codewen_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
    }
}
...
impl From<codewen_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: codewen_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<codewen_protocol::dynamic_tools::DynamicToolCallOutputContentItem>
...
impl From<DynamicToolCallOutputContentItem>
    for codewen_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
