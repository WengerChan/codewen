...
use codewen_protocol::protocol::RealtimeAudioFrame as CoreRealtimeAudioFrame;
...
pub struct ThreadRealtimeStartParams {
    ...
    #[ts(optional = nullable)]
    pub codewen_responses_as_items: Option<bool>,
    // TODO: Remove this experiment-only prefix with `codewen_responses_as_items`.
    /// Optional prefix added to automatic Codex response items when `codewenResponsesAsItems` is true.
    #[ts(optional = nullable)]
    ...
    #[ts(optional = nullable)]
    pub codewen_response_handoff_mode: Option<CodewenResponseHandoffMode>,
