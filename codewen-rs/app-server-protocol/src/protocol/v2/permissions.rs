...
use codewen_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use codewen_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use codewen_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use codewen_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use codewen_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use codewen_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
use codewen_protocol::models::LegacyReadWriteRoots;
...
use codewen_utils_path_uri::PathConvention;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> codewen_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<codewen_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: codewen_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            codewen_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            codewen_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            codewen_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
