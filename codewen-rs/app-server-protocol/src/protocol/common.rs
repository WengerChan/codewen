...
/// Superset of [`codewen_file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
...
mod tests {
    ...
    fn serialize_mcp_server_elicitation_request() -> Result<()> {
        ...
        let params = v2::McpServerElicitationRequestParams {
            ...
            server_name: "codewen_apps".to_string(),
        ...
        let response = ClientResponse::ThreadStart {
            ...
            response: v2::ThreadStartResponse {
                ...
                instruction_sources: vec![
                    codewen_utils_path_uri::LegacyAppPathString::from_abs_path(&absolute_path(
                        "/tmp/AGENTS.md",
                    )),
                ],
    ...
    fn serialize_account_login_chatgpt_streamlined() -> Result<()> {
        let request = ClientRequest::LoginAccount {
            ...
            params: v2::LoginAccountParams::Chatgpt {
                app_brand: None,
                codewen_streamlined_login: true,
                use_hosted_login_success_page: false,
            },
        };
        assert_eq!(
    ...
    fn account_serializes_fields_in_camel_case() -> Result<()> {
        ...
        let codewen_managed_bedrock = v2::Account::AmazonBedrock {
            uses_codewen_managed_credentials: true,
        };
        assert_eq!(
            json!({
                "type": "amazonBedrock",
                "usesCodewenManagedCredentials": true,
            }),
            serde_json::to_value(&codewen_managed_bedrock)?,
        );
        ...
        assert_eq!(
            json!({
                "type": "amazonBedrock",
                "usesCodewenManagedCredentials": false,
            }),
        ...
        let notification =
            ServerNotification::ThreadSettingsUpdated(v2::ThreadSettingsUpdatedNotification {
                ...
                thread_settings: v2::ThreadSettings {
                    ...
                    effort: None,
                    summary: None,
                    collaboration_mode: codewen_protocol::config_types::CollaborationMode {
