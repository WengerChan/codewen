...
mod guard_limits {
    pub(super) const CODEX_LIMIT_ID: &str = "codewen";
}
...
mod stage_one {
    pub(super) const REASONING_EFFORT: codewen_protocol::openai_models::ReasoningEffort =
        codewen_protocol::openai_models::ReasoningEffort::Low;
...
mod stage_two {
    pub(super) const REASONING_EFFORT: codewen_protocol::openai_models::ReasoningEffort =
        codewen_protocol::openai_models::ReasoningEffort::Medium;
    pub(super) const JOB_LEASE_SECONDS: i64 = 3_600;
    pub(super) const JOB_RETRY_DELAY_SECONDS: i64 = 3_600;
...
pub fn memory_root(codewen_home: &AbsolutePathBuf) -> AbsolutePathBuf {
    codewen_home.join("memories")
}
