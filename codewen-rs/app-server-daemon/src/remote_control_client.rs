...
use codewen_app_server_protocol::RemoteControlDisableParams;
use codewen_app_server_protocol::RemoteControlDisableResponse;
use codewen_app_server_protocol::RemoteControlEnableParams;
...
async fn connect_with_retry(
    ...
    connect_timeout: Duration,
    connect_retry_delay: Duration,
) -> Result<WebSocketStream<codewen_uds::UnixStream>> {
...
mod tests {
    ...
    const TEST_CODEWEN_HOME: &str = "/tmp/codewen-home";
        ...
        client::send_message(
            ...
            &JSONRPCMessage::Response(JSONRPCResponse {
                ...
                result: serde_json::json!({
                    "userAgent": "codewen_app_server/1.2.3",
                    "codexHome": TEST_CODEWEN_HOME,
                    "platformFamily": "unix",
                    "platformOs": "macos",
                }),
            }),
