...
use codewen_utils_path_uri::PathUriParseError;
pub use parser::Hunk;
...
///
/// Although this constant lives in `codewen-apply-patch` (to avoid forcing
/// `codewen-arg0` to depend on `codewen-core`), it remains part of the "codewen core"
/// process-invocation contract for the standalone `apply_patch` command
/// surface.
pub const CODEX_CORE_APPLY_PATCH_ARG1: &str = "--codewen-run-as-apply-patch";
