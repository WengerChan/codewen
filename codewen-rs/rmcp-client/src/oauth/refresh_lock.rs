...
const LOCK_CONTENTION_EVENT_TARGET: &str = "codewen_rmcp_client::oauth::refresh_lock::contention";
...
impl RefreshCredentialLock {
    pub(super) async fn acquire_for_server(server_name: &str, url: &str) -> Result<Self> {
        ...
        Self::acquire_in(&codewen_home, &store_key, REFRESH_LOCK_ACQUIRE_TIMEOUT)
            .await
