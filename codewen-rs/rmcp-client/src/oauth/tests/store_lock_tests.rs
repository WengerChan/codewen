...
const LOCK_HOLDER_READY_PATH_ENV: &str = "CODEWEN_OAUTH_STORE_LOCK_CHILD_READY_PATH";
    ...
    T: Send + 'static,
{
    std::thread::scope(|scope| {
        let held_lock =
            OAuthStoreLock::acquire_in(codewen_home, store, Duration::from_millis(/*millis*/ 100))?;
