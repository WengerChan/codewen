...
fn streamable_http_server_bin() -> Result<PathBuf, CargoBinError> {
    codewen_utils_cargo_bin::cargo_bin("test_streamable_http_server")
}
...
fn init_params() -> InitializeRequestParams {
    ...
    InitializeRequestParams::new(
        capabilities,
        Implementation::new("codewen-test", "0.0.0-test").with_title("Codex rmcp recovery test"),
    )
...
/// Reads the websocket URL printed by `codewen exec-server --listen`.
