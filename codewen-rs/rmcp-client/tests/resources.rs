...
const RESOURCE_URI: &str = "memo://codewen/example-note";

fn stdio_server_bin() -> Result<PathBuf, CargoBinError> {
    codewen_utils_cargo_bin::cargo_bin("test_stdio_server")
}
...
fn init_params() -> InitializeRequestParams {
    ...
    InitializeRequestParams::new(
        capabilities,
        Implementation::new("codewen-test", "0.0.0-test").with_title("Codex rmcp resource test"),
    )
