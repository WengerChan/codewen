...
use codewen_utils_image::data_url_from_bytes;
...
use codewen_utils_image::ImageProcessingError;
...
fn convert_mcp_content_to_items(
    ...
    const CODEX_ENCRYPTED_CONTENT_META_KEY: &str = "codewen/encryptedContent";
    const CODEX_IMAGE_DETAIL_META_KEY: &str = "codewen/imageDetail";
...
// (Moved event mapping logic into codewen-core to avoid coupling protocol to UI-facing events.)
...
mod tests {
    ...
    fn function_call_deserializes_optional_namespace() {
        let item: ResponseItem = serde_json::from_value(serde_json::json!({
            "type": "function_call",
            "name": "mcp__codewen_apps__gmail_get_recent_emails",
            "namespace": "mcp__codewen_apps__gmail",
            "arguments": "{\"top_k\":5}",
            "call_id": "call-1",
        }))
        ...
        assert_eq!(
            ...
            ResponseItem::FunctionCall {
                id: None,
                name: "mcp__codewen_apps__gmail_get_recent_emails".to_string(),
                namespace: Some("mcp__codewen_apps__gmail".to_string()),
        ...
        for i in 0..200 {
            exec_policy
                .add_prefix_rule(
                    ...
                    codewen_execpolicy::Decision::Allow,
                )
                .expect("add rule");
        }
    ...
    fn tool_search_output_roundtrips() -> Result<()> {
        let input = ResponseInputItem::ToolSearchOutput {
            ...
            tools: vec![serde_json::json!({
                "type": "function",
                "name": "mcp__codewen_apps__calendar_create_event",
