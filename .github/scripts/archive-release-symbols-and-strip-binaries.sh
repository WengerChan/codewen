...
symbols_root="${RUNNER_TEMP:-/tmp}/codewen-symbols-${artifact_name}"
symbols_dir="${symbols_root}/codewen-symbols-${artifact_name}"
archive_path="${archive_dir%/}/codewen-symbols-${artifact_name}.tar.gz"
rm -rf "$symbols_root"
...
rm -f "$archive_path"
tar -C "$symbols_root" -czf "$archive_path" "codewen-symbols-${artifact_name}"
