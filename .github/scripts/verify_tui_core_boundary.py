...
"""Verify codewen-tui does not depend on or import codewen-core directly."""
...
TUI_ROOT = ROOT / "codewen-rs" / "tui"
TUI_MANIFEST = TUI_ROOT / "Cargo.toml"
FORBIDDEN_PACKAGE = "codewen-core"
...
def main() -> int:
    ...
    print("codewen-tui must not depend on or import codewen-core directly.")
    print(
