...
PACKAGE_VARIANTS: dict[str, PackageVariant] = {
    "codewen": PackageVariant(
        name="codewen",
        cargo_bin="codewen",
        executable_stem="codewen",
    ),
    "codewen-app-server": PackageVariant(
        name="codewen-app-server",
        cargo_bin="codewen-app-server",
        executable_stem="codewen-app-server",
    ),
}
